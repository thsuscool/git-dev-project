 ...
 * <p/>
 */
public class CommunityClose extends AbsQuery<HashMap<String,Object>> {
	private static final Log logger = LogFactory.getLog(CommunityClose.class);
	@Override
	...
	public HashMap<String,Object> executeAPI(
		...
		try {
			...
			if(!community.get("usr_id").equals(login_id)){
				...
				resultData.put("success", (int)session.update("communityMap.updateCmmntyClose",mapParameter)>0);
			}
