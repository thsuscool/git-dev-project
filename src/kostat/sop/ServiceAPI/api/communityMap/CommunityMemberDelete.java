 ...
 * <p/>
 */
public class CommunityMemberDelete extends AbsQuery<HashMap<String,Object>> {
	private static final Log logger = LogFactory.getLog(CommunityMemberDelete.class);
	...
	public HashMap<String,Object> executeAPI(
		...
		try {
			...
			if(!community.get("usr_id").equals(login_id)){
				...
				resultData.put("success", session.delete("communityRegistMember.deleteCmmntyMapRegMber",mapParameter)>0);
			}
