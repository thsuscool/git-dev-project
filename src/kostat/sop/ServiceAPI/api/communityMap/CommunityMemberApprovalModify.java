 ...
 * <p/>
 */
public class CommunityMemberApprovalModify extends AbsQuery<HashMap<String,Object>> {
	private static final Log logger = LogFactory.getLog(CommunityMemberApprovalModify.class);
