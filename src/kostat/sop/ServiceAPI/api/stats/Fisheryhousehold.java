...
/**
* 어가 통계 API
* 어가에 대한 통계를 제공하기 위한 API
* <pre>
* input : fisheryhousehold.json/xml
* output : json/xml
...
public class Fisheryhousehold extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(Fisheryhousehold.class);
	@Override
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			StatUtil.setPercent( "fishery_cnt"
	...
	protected void optimizeParameterMap(Map mapParameter) throws ApiException {
		...
		String fishery_type = (String) mapParameter.get("fishery_type");
