...
public class BusStopPoiList extends AbsQuery<List>{
	private static final Log logger = LogFactory.getLog(BusStopPoiList.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//공공데이터 목록
			resultData = publicDataService.selectBrtPoiList(mapParameter);
