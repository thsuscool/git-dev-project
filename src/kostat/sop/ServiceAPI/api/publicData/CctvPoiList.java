...
public class CctvPoiList extends AbsQuery<List>{
	private static final Log logger = LogFactory.getLog(CctvPoiList.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//공공데이터 목록
			resultData = publicDataService.selectCctvPoiList(mapParameter);
