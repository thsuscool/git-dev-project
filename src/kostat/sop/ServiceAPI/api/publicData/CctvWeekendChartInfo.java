...
public class CctvWeekendChartInfo extends AbsQuery<List>{
	private static final Log logger = LogFactory.getLog(CctvWeekendChartInfo.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//공공데이터 목록
			resultData = publicDataService.selectCctvWeekendChartInfo(mapParameter);
