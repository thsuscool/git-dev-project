...
public class DataDelete extends AbsQuery<List> {
private static final Log logger = LogFactory.getLog(DataDelete.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			/*session.delete("mypage.userData", req.getParameter("data_id"));
			session.delete("mypage.deleteMataData", req.getParameter("data_id"));
			session.delete("mypage.deleteMain",  req.getParameter("data_id"));
			*/
