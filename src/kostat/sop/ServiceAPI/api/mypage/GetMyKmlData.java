...
public class GetMyKmlData extends AbsQuery<List> {
private static final Log logger = LogFactory.getLog(GetMyKmlData.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.add(mypageService.selectMyKmlData(req.getParameter("file_path"),req.getParameter("file_nm_logic"),req.getParameter("file_nm_real")));
