...
public class SharedDataList extends AbsQuery<Map> {
private static final Log logger = LogFactory.getLog(SharedDataList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//공유 데이터 총 개수
			int totalcount = mypageService.sharedDataTotalCount(mapParameter);
			...
			//공유 데이터 리스트
			List list = mypageService.selectSharedDataList(mapParameter);
