...
public class UpdateMyKmlData extends AbsQuery<List> {
private static final Log logger = LogFactory.getLog(UpdateMyKmlData.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mypageService.updateMyKmlData(mapParameter);
