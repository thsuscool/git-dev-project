...
import kostat.sop.ServiceAPI.api.gallery.InsertGalleryPollVoteInfo.MustParam;
import kostat.sop.ServiceAPI.api.gallery.InsertGalleryPollVoteInfo.OptionParam;
...
public class UpdateGalleryPollVoteInfo extends AbsQuery<Map> {
...
///////////////////////////////			
			...
			int resultCnt = galleryService.updateGalleryPollVoteInfo(mapParameter);
