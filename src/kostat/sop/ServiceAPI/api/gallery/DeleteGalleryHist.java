...
public class DeleteGalleryHist extends AbsQuery<Map>{
	private static final Log logger = LogFactory.getLog(DeleteGalleryHist.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			galleryService.deleteGalleryHist(mapParameter.get("hist_id").toString(),login_id);
