...
public class AddMyGallery extends AbsQuery<Map> {
private static final Log logger = LogFactory.getLog(AddMyGallery.class);
...
///////////////////////////////			
			...
			if(galleryService.existMyGallery(mapParameter) == false){
				//갤러리 추가
				galleryService.addMyGallery(mapParameter);
				resultData.put("insertYN",true);
			}else{
				throw new ApiException("이미 추가된 데이터 입니다.");
				/*resultData.put("insertYN",false);*/
			}
