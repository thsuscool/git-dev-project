...
public class PoiCompanyDensity extends AbsQuery<List>{
	private static final Log logger = LogFactory.getLog(PoiCompanyDensity.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//임의 영역 반경 내 집계구경계
			result = bizStatsMapService.selectPoiCompanyDensity(mapParameter);
