...
/**
* 영역내 연도별 학교 정보제공 API
* Boundary 경계내에 포함되는 연도별 학교 정보조회
* <pre>
* input : poietcschoolppln.json/xml
* output : json/xml
* Table : SOD_SCHOO_INFO
* </pre>
*
* <pre>
* <b>History:</b>
...
public class PoiEtcSchoolPpln extends AbsQuery<List> {
	...
	protected String getQueryStr() {
		return "bizStats.poietcschoolppln";
	}
