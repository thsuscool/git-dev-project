 ...
 * <p/>
 */
public class UpdateOpenYnPolicyMap extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(UpdateOpenYnPolicyMap.class);
		...
		try {
			...
			if (policyMapInfo != null) {
				...
				if (usr_id.equals(member_id)) {
					//지표 수정
					int result = policyWriteService.updateOpenYnPolicyMap(mapParameter);
				}
			}
