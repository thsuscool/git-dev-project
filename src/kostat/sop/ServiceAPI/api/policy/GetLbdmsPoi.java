...
public class GetLbdmsPoi extends AbsQuery<HashMap<String,Object>> {
	private static final Log logger = LogFactory.getLog(GetLbdmsPoi.class);
	@Override
	...
	public HashMap<String,Object> executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("total_count", session.selectOne("policyStatic.selectLbdmsPoiCount",mapParameter));
			result.put("summaryList", session.selectList("policyStatic.selectLbdmsPoiList",mapParameter));
