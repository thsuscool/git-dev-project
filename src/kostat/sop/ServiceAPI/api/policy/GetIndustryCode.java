 ...
 * <p/>
 */
public class GetIndustryCode extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(GetIndustryCode.class);
	...
	public List executeAPI(
		...
		try {
			...
			resultData = policyWriteService.getIndustryCode(mapParameter);
