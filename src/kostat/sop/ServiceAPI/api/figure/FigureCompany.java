...
public class FigureCompany extends AbsQuery<List> {
	
	private static final Log logger = LogFactory.getLog(FigureCompany.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result = session.selectList("figure.companybord", mapParameter);
