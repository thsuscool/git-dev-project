...
public class FigureEtc extends AbsQuery<List> {
	
	private static final Log logger = LogFactory.getLog(FigureEtc.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result = session.selectList("figure.etcfacbord", mapParameter);
