...
public class GetSggCompanyMapInfo extends AbsQuery<List>{

	private static final Log logger = LogFactory.getLog(GetSggCompanyMapInfo.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result = technicalBizMapService.selectSggCompanyMapInfo(mapParameter);
