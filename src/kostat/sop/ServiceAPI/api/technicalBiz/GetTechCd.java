...
public class GetTechCd extends AbsQuery<Map> {
	
	private static final Log logger = LogFactory.getLog(GetTechCd.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("techCdList", technicalBizMapService.getTechCd(mapParameter));
