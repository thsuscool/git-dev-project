...
public class TechnicalBizVariateLineChart extends AbsQuery<Map> {

	private static final Log logger = LogFactory.getLog(TechnicalBizVariateLineChart.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List chartData = technicalBizMapService.selectTechnicalBizVariateLineChart(mapParameter);
