...
import kostat.sop.ServiceAPI.api.technicalBiz.GetTechCd.MustParam;
import kostat.sop.ServiceAPI.api.technicalBiz.GetTechCd.OptionParam;
...
public class GetSigunguRank extends AbsQuery<Map>{
	
	private static final Log logger = LogFactory.getLog(GetSigunguRank.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("sigunguRankList", technicalBizMapService.getSigunguRank(mapParameter));
