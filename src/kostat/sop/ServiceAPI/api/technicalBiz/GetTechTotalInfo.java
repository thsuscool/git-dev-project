...
public class GetTechTotalInfo extends AbsQuery<List>{

	private static final Log logger = LogFactory.getLog(GetTechTotalInfo.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			for(int i = 0; i < amdCdArray.length ; i++){
				...
				returnList.add(technicalBizMapService.searchTechTotalInfo(paramMap));
