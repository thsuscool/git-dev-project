...
public class GetSidoFeatureDetail extends AbsQuery<Map>{

	private static final Log logger = LogFactory.getLog(GetSidoFeatureDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("featureDetail", technicalBizMapService.getSidoFeatureDetail(mapParameter));
