...
public class GetNewCorpInfoList extends AbsQuery<List> {
	
	private static final Log logger = LogFactory.getLog(GetNewCorpInfoList.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			...
			result =  technicalBizMapService.selectNewCorpInfoList(mapParameter);
