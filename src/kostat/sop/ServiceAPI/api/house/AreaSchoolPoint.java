 ...
 * <p/>
 */
public class AreaSchoolPoint extends AbsQuery<List<?>> {
	private static final Log logger = LogFactory.getLog(AreaSchoolPoint.class);
	@Override
...
//			}
			...
			resultData = session.selectList("house.selectSchoolPoint",mapParameter);
