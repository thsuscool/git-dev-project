															...
															"<div class='remarkbox'>" +
																"<div class='remarkbox_in'>" +
																	...
																	"<div class='remarks_list'>" +
																		"<ul>" +
																			"<li><span id='legendColor1_"+that.id+"' style='background: #ffddd7;'>&nbsp;</span><a id='legendRange1'>-</a></li>" +
																			"<li><span id='legendColor2_"+that.id+"' style='background: #ffb2a5;'>&nbsp;</span><a id='legendRange2'>-</a></li>" +
																			"<li><span id='legendColor3_"+that.id+"' style='background: #ff806c;'>&nbsp;</span><a id='legendRange3'>-</a></li>" +
																			"<li><span id='legendColor4_"+that.id+"' style='background: #ff593f;'>&nbsp;</span><a id='legendRange4'>-</a></li>" +
																			"<li><span id='legendColor5_"+that.id+"' style='background: #ff2400;'>&nbsp;</span><a id='legendRange5'>-</a></li>" +
																		"</ul>" +
																	"</div>" +
...
//					$("#legend_modal").dialog({width: 100, minimize: '#minimizeArea'});
				...
				this.createLegend = function() {
					...
					infoLegend.update = function (props) {
						this._div.innerHTML = "<div class='legend_remark_section'>" +
															"<a class='btn_remark'><img class='rollover' src='/img/im/btn_remarks_off.png' alt='' /></a>" +
															"<div class='remarkbox' style='width:230px;'>" +
																"<div class='remarkbox_in'>" +
																	"<p class='remarks_tit'>" +
																		"<input id='economy_btn' class='rsc_btn' type='button' value='경제' style='width:50px;height:26px;margin-left:30px;margin-top:-5px;'>" +
																		"<input id='society_btn' class='rsc_btn' type='button' value='사회' style='width:50px;height:26px;margin-top:-5px;'>" +
																		"<input id='agriculture_btn' class='rsc_btn' type='button' value='농어업' style='width:50px;height:26px;margin-top:-5px;'>" +
																	...
																	"<div class='remarks_list'>" +
																		"<ul id='society_legend' style='display:block;height:156px;overflow:auto;'>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_007' value='DRSC_007' style='margin-left:10px;'><span style='background: #FFC519;'>&nbsp;</span><a>경제활동인구조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_008' value='DRSC_008' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>가계동향조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_009' value='DRSC_009' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>집세조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_010' value='DRSC_010' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>비농가양곡조사</a></li>" +
																		"</ul>" +
																		"<ul id='economy_legend' style='display:none;height:156px;overflow:auto;'>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_001' value='DRSC_001' style='margin-left:10px;'><span style='background: #FFC519;'>&nbsp;</span><a>광업제조업동향조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_002' value='DRSC_002' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>기계수주동향조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_003' value='DRSC_003' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>건설경기동향조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_004' value='DRSC_004' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>서비스업</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_005' value='DRSC_005' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>온라인쇼핑</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_006' value='DRSC_006' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>소비자물가조사</a></li>" +
																		"</ul>" +
																		"<ul id='agriculture_legend' style='display:none;height:156px;overflow:auto;'>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_011' value='DRSC_011' style='margin-left:10px;'><span style='background: #FFC519;'>&nbsp;</span><a>농가경제조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_012' value='DRSC_012' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>농산물생산비조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_013' value='DRSC_013' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>축산물생신비조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_014' value='DRSC_014' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>농가판매 및 구입가격조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_015' value='DRSC_015' style='margin-left:10px;'><span style='background: #FFC519;'>&nbsp;</span><a>산지쌀값조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_016' value='DRSC_016' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>가축동향조사전수</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_017' value='DRSC_017' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>가축동향조사표본</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_018' value='DRSC_018' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>작물재배면적조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_019' value='DRSC_019' style='margin-left:10px;'><span style='background: #FFC519;'>&nbsp;</span><a>어가경제조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_020' value='DRSC_020' style='margin-left:10px;'><span style='background: #69B319;'>&nbsp;</span><a>내수면양식조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_021' value='DRSC_021' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>내수면어로조사</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_022' value='DRSC_022' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>비계통전수(양식품종조사)</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_023' value='DRSC_023' style='margin-left:10px;'><span style='background: #00A0F3;'>&nbsp;</span><a>비계통표본</a></li>" +
																			"<li><input type='checkbox' checked='checked' id='DRSC_024' value='DRSC_024' style='margin-left:10px;'><span style='background: #FF59B6;'>&nbsp;</span><a>어류양식동향조사</a></li>" +
																		"</ul>" +
																	"</div>" +
																	"<a class='btn_remark_offset'><img class='rollover' src='/img/im/icon_arrow_remark_off.gif' alt='최소화' title='최소화' /></a>" +
																"</div>" +
					...
					$(".rsc_btn").click(function() {
						var id = $(this).attr("id");
						console.log(id);
						if (id == "economy_btn") {
							$("#economy_legend").show();
							$("#society_legend").hide();
							$("#agriculture_legend").hide();
						}else if (id == "society_btn") {
							$("#economy_legend").hide();
							$("#society_legend").show();
							$("#agriculture_legend").hide();
						}else {
...
//																	"</tr>" +
				...
				this.createUserUploadFile = function() {
					...
					infoUserUpload.update = function (props) {
						this._div.innerHTML = "<div style='position:absolute; right:55px; top:10px; width:45px;'>" +
													"<a class='btn_graph'><img class='rollover' src='/img/im/btn_remarks_off.png' alt='' /></a>" +
														"<div class='graphbox' style='width:300px;'>" +
															"<div class='graphbox_in'>" +
																"<div class='graph'>" +
																"<div class='m_indicator' style='position:absolute; width:100%; height:100%; z-index:10000; display:none'><img style='margin-top:25%;' src='/img/common/loding_type01.gif'/></div>" +
																	/*"<div style='height:35px;float:left;line-height:25px;'><span style='margin-left:10px'>*위치보기를 할 경우, 위치정보조회를 해주세요. (업로드한 정보중 최대 300개까지만 표출됩니다.)</span></div>" +*/
																	"<div class='userUploadBox' id='userUploadView_"+ that.id +"' style='width:280px;'>" +
																	"<div style='width:280px;height:125px;overflow-y:scroll; margin:0 auto; border: 1px solid;'>" +
																	"<table border=1 id='drscList' width=100% class='display' style='text-align:center;margin:auto;table-layout:auto;'>" +
																		"<thead>" +
																			"<tr style='height:25px;background-color:#eeeeee;'>" +
																				"<td style='font-size:11px;'><input type='checkbox' id='all_drsc'></td>" +
																				"<td colspan=2 style='width:60px;font-size:11px;'>부문별 조사항목</td>" +
																	...
																	"<div style='height:25px;'>" +
																		"<span style='font-size:11px;'>해당 담당조사원 리스트 : </span>" +
																		"<span id='tot_person' style='font-size:11px;'></span>" +
																	"</div>" +
																	"<div style='width:263px; margin: 0 0 10px 10px;	'>" +
																		"<table border=1 width=100% class='display' style='text-align:center;margin:auto; '>" +
																			"<tr style='height:25px;'>" +
																				"<td style='width:60px;'><input type='checkbox' id='marcker_cluster'></td>" +
																				"<td colspan=2 style='font-size:11px;'>Marker Cluster</td>" +
																			"</tr>" +
																		"</table>" +
																	"</div>" +
																	"<div style='width:280px;height:325px;overflow-y:scroll; margin:0 auto; border: 1px solid;'>" +
																	"<table border=1 id='userUpload_"+ that.id +"' width=100% class='display' style='text-align:center;margin:auto; '>" +
																		"<thead>" +
																			"<tr style='height:25px;background-color:#eeeeee;'>" +
																				"<td style='width:60px;font-size:11px;'><input type='checkbox' id='all_person'></td>" +
																				"<td style='font-size:11px;'>담당자</td>" +
																				"<td style='width:60px;font-size:11px;'>번호</td>" +
																			"</tr>" +
																		"</thead>" +
																		"<tbody></tbody>" +
																	"</table>" +
																...
																"</div>" +
															"</div>" +
															"<a class='btn_graph_offset' style='right:8px;'><img class='rollover' src='/img/im/icon_arrow_graph_off.gif' alt='최소화' title='최소화' /></a>" +
														"</div>" +
													"</div>";
					...
					$("#userExcelUpload_"+that.id).draggable({
						drag : function(event, ui) {
							if (ui.position.top <= -200) {
								ui.position.top = -200;
								$("#userExcelUpload_"+that.id).offset(ui.position);
							}
							if (ui.position.top >= $(document).height() - $(document).height()/3) {
								ui.position.top = $(document).height() - $(document).height()/3;
								$("#userExcelUpload_"+that.id).offset(ui.position);
							}
							
							if (ui.position.left <= -($(document).width() - $(document).width()/3)) {
								ui.position.left = -($(document).width() - $(document).width()/3);
								$("#userExcelUpload_"+that.id).offset(ui.position);
							}
				...
				this.showPersonList = function(data, categories, office) {
					
					$("#all_drsc").prop("checked", false);
					$("#all_person").prop("checked", false);
					$("#all_drsc").off("click");
					$("#all_person").off("click");
					
					var categoryList = categories.split(",");
					var html = "";
					for (var i=0; i<categoryList.length; i++) {
						if (categoryList[i] == "RSC_001") {
							for (var x=1; x<=6; x++) {
								var id = "DRSC_00"+ x;
								html += "<tr class='TH_RSC_001' style='height:25px;'>";
								html += "<td style='width:60px;'><input type='checkbox' class='eachDRSC' id='"+ id +"' value='"+ id +"'></td>";
								html += "<td style='font-size:11px;'>"+ this.drsc_nm[id] +"</td>";
								html += "<td style='width:60px;'><img src='/img/honam/"+id+"_middle.png' style='margin-top:2px; width:18px; height:18px;'></td>";                                   
								html += "</tr>";
							}					
						}
						
						if (categoryList[i] == "RSC_002") {
							for (var x=7; x<=10; x++) {
								var id = "";
								if (x == 10) {
									id = "DRSC_0"+ x;
								...
								html += "<tr class='TH_RSC_002' style='height:25px;'>";
								html += "<td style='width:60px;'><input type='checkbox' class='eachDRSC' id='"+ id +"' value='"+ id +"'></td>";
								html += "<td style='font-size:11px;'>"+ this.drsc_nm[id] +"</td>";
								html += "<td style='width:60px;'><img src='/img/honam/"+id+"_middle.png' style='margin-top:2px; width:18px; height:18px;'></td>";                                   
								html += "</tr>";
						...
						if (categoryList[i] == "RSC_003") {
							for (var x=11; x<=24; x++) {
								var id = "DRSC_0"+ x;			
								html += "<tr class='TH_RSC_003' style='height:25px;'>";
								html += "<td style='width:60px;'><input type='checkbox' class='eachDRSC' id='"+ id +"' value='"+ id +"'></td>";
								html += "<td style='font-size:11px;'>"+ this.drsc_nm[id] +"</td>";
								html += "<td style='width:60px;'><img src='/img/honam/"+id+"_middle.png' style='margin-top:2px;width:18px; height:18px;'></td>";                                   
								html += "</tr>";
					...
					for (var p in result) {
						for (var i=0; i<result[p].length; i++) {
							if (i==0) {
								html += "<tr class='rsc_header'>" +
										"<td colspan=3 style='height:25px; text-algin:left;background:#eeeeee; font-size:11px;'>"+ result[p][i].nm + " ( " + parseInt(result[p].length) + "명 )</td>" +
										"</tr>";
							}
							
							html += "<tr id='"+p+"_"+result[p][i].person_id+"' style='height:25px;'>";
							html += "	<td><input type='checkbox' class='eachPerson' id='"+result[p][i].person_id +"' value='"+parseInt(length+i)+ "_"+ result[p][i].person_id +"'></td>";
							html += "	<td style='font-size:11px;'><span>"+ result[p][i].person +"</span></td>";
							html += "	<td style='font-size:11px;'>"+ parseInt(length+i) +"</td>";
							html += "</tr>";
						}
						length += result[p].length;
					}
					$("#userUpload_"+ that.id + " > tbody").html(html);
					
					$("#tot_person").text("총 " + parseInt(length-1) + " 명");
					
					$(".eachPerson").click(function() {
						var isCheck = $(this).is(":checked");
						var isCluster = $("#marcker_cluster").is(":checked");
						var tmpData = $(this).val().split("_");
						var person = tmpData[1];
						var no = tmpData[0];
						var category2 = []; 
						$("#drscList > tbody").find($("input:checked")).each(function() {
						...
						if (!isCheck) {
							...
							for(var i=0; i<$honamMap.ui.markerGroup.length; i++) {
								var markerInfo = $honamMap.ui.markerGroup[i];
								if (markerInfo.person == person) {
									if (isCluster) {
										that.map.markers.removeLayer(markerInfo.marker);
									}else {
										that.map.gMap.removeLayer(markerInfo.marker);
									}
								}else {
									tmpArray.push(markerInfo);
								}
							}
							
							$honamMap.ui.markerGroup = tmpArray;
							
						}else {

							for (var i=0; i<category2.length; i++) {
								$honamMapApi.request.addressInfoList(person, categories, category2[i], no);
							}
						}
						
						if ($(".eachPerson:checked").length == $(".eachPerson").length) {
							$("#all_person").prop("checked", true);
						}else {
							$("#all_person").prop("checked", false);
						}
					...
					//전체 담당자 선택
					$("#all_person").click(function() {
						var isCheck = $(this).is(":checked");
						if (isCheck) {
							$("#userUpload_"+ that.id + " > tbody").find($("input")).each(function() {
					...
					//선택된 세부조사에 해당하는 담당자만 마커생성
					$("#drscList > tbody").find($("input")).click(function() {
						var isCheck = $(this).is(":checked");
						var isCluster = $("#marcker_cluster").is(":checked");
						var category = $(this).val();
						
						if (isCheck) {
							$honamMapApi.request.personInfoListForCategory(category, office);
						}else {
							var categories = []; 
							$("#drscList > tbody").find($("input:checked")).each(function() {
							...
							var tmpArray = [];
							for(var x=0; x<$honamMap.ui.markerGroup.length; x++) {
								var markerInfo = $honamMap.ui.markerGroup[x];
								var group = markerInfo.marker;

								if (markerInfo.category2 == category) {
									$("#"+markerInfo.person).prop("checked", false);
									if (isCluster) {
										that.map.markers.removeLayer(group);
									}else {
										that.map.gMap.removeLayer(group);
									}
							...
							for(var x=0; x<$honamMap.ui.markerGroup.length; x++) {
								...
								for (var i=0; i<categories.length; i++) {
									if (markerInfo.category2 == categories[i]) {
										$("#"+markerInfo.person).prop("checked", true);
									}
								}
							}
						}
						...
						console.log($("#drscList > tbody").find($("input:checked")).length);
						console.log($("#drscList > tbody").find($("input")).length);
						if ($("#drscList > tbody").find($("input:checked")).length == $("#drscList > tbody").find($("input")).length) {
							$("#all_drsc").prop("checked", true);
						}else {
							$("#all_drsc").prop("checked", false);
						}
					...
					//세부조사 전체선택
					$("#all_drsc").click(function() {
						console.log("ffdff");
						var isCheck = $(this).is(":checked");
						var isCluster = $("#marcker_cluster").is(":checked");
						if (isCheck) {
							for (var i=0; i<$honamMap.ui.markerGroup.length; i++) {
								var group = $honamMap.ui.markerGroup[i].marker;
								if (isCluster) {
							...
							$("#drscList > tbody").find($("input")).each(function() {
					...
					//마커 클러스터 on/off
					$("#marcker_cluster").click(function() {
						var isCheck = $(this).is(":checked");
						if (isCheck) {
							for(var i=0; i<$honamMap.ui.markerGroup.length; i++) {
								var group = $honamMap.ui.markerGroup[i].marker;
								map.gMap.removeLayer(group);
							}
							setTimeout(function() {
								map.markers.clearLayers();
								for(var i=0; i<$honamMap.ui.markerGroup.length; i++) {
									var group = $honamMap.ui.markerGroup[i].marker;
									map.markers.addLayer(group);
								}
							}, 200);
							...
							map.markers.clearLayers();
							for(var i=0; i<$honamMap.ui.markerGroup.length; i++) {
								var markerGroup = sop.featureGroup();
								map.gMap.addLayer(markerGroup);
								
								var group = $honamMap.ui.markerGroup[i].marker;
								map.gMap.addLayer(group);
							}
						}
					});
					...
					//첫번째 세부조사를 클릭
					$("#drscList > tbody").find($("input"))[0].click();
					
					$(that.infoUserUploadObj).show();
					$(that.infoUserUploadObj).find(".graphbox").show();
					$(that.legendObj).show();
					$(that.legendObj).find(".remarkbox").show();
					
				},
				
				this.checkPerson = function(data, category2) {
					for (var office in data) {
						for (var i=0; i<data[office].length; i++) {
							$(".eachPerson").each(function() {
								var id = $(this).attr("id");
								if (id == data[office][i].person_id) {
									$("#"+id).prop("checked", true);
									
									var info = $("#"+id).val();
									var no = info.split("_")[0];
									var category1 = "RSC_002";
									
									var tmp = category2.split("_")[1]
									if (parseInt(tmp) < 7) category1 = "RSC_001";
									else if (parseInt(tmp) >= 7 && parseInt(tmp) < 11) category1 = "RSC_002";
									else category1 = "RSC_003";
									
									$honamMapApi.request.addressInfoList(id, category1, category2, no);
								}
							})
...
//					$("#legend_"+that.id).find(".remarkbox").show();
				...
				this.updateSearchTitle = function (options) {
					...
					if (options.params == undefined ) {		//KOSIS
						...
						for (var i=0; i<options.params.param.length; i++) {
							if (options.params.param[i].key == "year") {
								...
								} else */if(options.btntype == "items" || options.btntype == "combine") {	//결합일경우
									titleText = options.params.title;
								} else {
						...
						/*
							if(options.params.api_id == "API_0301" || options.params.api_id == "API_0302") {
								reference = "통계청, 인구주택총조사";
							} else if(options.params.api_id == "API_0304") {
								reference = "통계청, 전국사업체조사";
							} else if(options.params.api_id == "API_0305") {
								reference = "통계청, 인구주택총조사";
							} else if(options.params.api_id == "API_0306") {
								reference = "통계청, 인구주택총조사";
							} else if(options.params.api_id == "API_0307") {
								reference = "통계청, 농림어업총조사";
							} else if(options.params.api_id == "API_0308") {
								reference = "통계청, 농림어업총조사";
							} else if(options.params.api_id == "API_0309") {
								reference = "통계청, 농림어업총조사";
							} else if(options.params.api_id == "API_0310") {
								reference = "통계청, 농림어업총조사";
							} else {	//default
								reference = "통계청, 인구주택총조사";
							}*/
					...
					$(that.searchTitleObj).find(".title_txt").html(textSubString(titleText, 32));
					$("#searchTitle_"+that.id).find(".title_txt").tooltip({
		        		content : titleText,
		        		position : {my: "left+10 top-40"},
						track: true
		        	});
					$(that.searchTitleObj).find(".reference_txt").html(reference);
				...
				this.resetMapInfo = function() {
					...
					$(that.infoUserUploadObj).hide();
					$(that.infoUserUploadObj).find(".graphbox").hide();
					$(that.legendObj).hide();
					$(that.legendObj).find(".remarkbox").hide();
					
					
					$("#society_legend").find($("input")).prop("checked", "checked");
					$("#economy_legend").find($("input")).prop("checked", "checked");
					$("#agriculture_legend").find($("input")).prop("checked", "checked");
					
					/*$("#society_legend").find($("input")).prop("disabled", "disabled");
					$("#economy_legend").find($("input")).prop("disabled", "disabled");
					$("#agriculture_legend").find($("input")).prop("disabled", "disabled");*/
