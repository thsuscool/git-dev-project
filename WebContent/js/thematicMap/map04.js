					...
					$.ajax({
						  ...
						  success: function(res) {
							  if (res.errCd == "0") {
								  ...
								  var rightHtml= '<a href="javascript:$thematicMapFrame04.Popup.show();$thematicMapFrame04.ui.changeLeftRightValue(2)" class="first" id="rightValue">수('+unit+')</a>'
								...
								//통계선택 오른쪽버튼 생성
								  if (result.left_sep_nm !=null && result.left_sep_unit !=null && result.left_sep_nm.length > 0 && result.left_sep_unit.length > 0){
									  var leftHtml= '<a href="javascript:$thematicMapFrame04.Popup.show();$thematicMapFrame04.ui.changeLeftRightValue(1)" class="last" id="leftValue">'+ result.left_sep_nm+'('+result.left_sep_unit+')</a>'
					...
					$.ajax({
						...
						success: function(res) {
							if (res.errCd == "0") {
								...
								output += '<select id="select_base_year" onchange="javascript:$thematicMapFrame04.Popup.show();$thematicMapFrame04.ui.mapList[0].changeRegionBound()">';
