	...
	$thematicMapList.formatter = {
		getStatsThemeListHtml : function (statsThemeListObj) {
			...
			for ( var i = 0; i < statsThemeListObj.length; i++) {
				...
				statsThemeListObjHtml += '<a href="/view/thematicMap/thematicMapMain.view?theme=' + statsThemeListObj[i].category + '&stat_thema_map_file_url=' + statsThemeListObj[i].stat_thema_map_file_url + '&stat_thema_map_id=' + statsThemeListObj[i].stat_thema_map_id + '&mapType=' + statsThemeListObj[i].thema_map_type + '" style="font-size:18px">';
