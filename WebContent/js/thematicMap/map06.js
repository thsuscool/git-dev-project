...
//									$("#view1 .helperText span").text(res.result.getThemaStatsInfo[0].title);
								...
								if(that.id=="1"){
									if(result.left_sep_nm !=null && result.left_sep_unit !=null && result.left_sep_nm.length > 0 && result.left_sep_unit.length > 0){
										var leftHtml= '<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.changeLeftRightValue()" class="first" id="leftValue">'+ result.left_sep_nm+'('+result.left_sep_unit+','+result.sep_map_left_sep_unit+')</a>'
									...
									if(result.right_sep_nm !=null && result.right_sep_unit!=null && result.right_sep_nm.length > 0 && result.right_sep_unit.length > 0){
										var rightHtml= '<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.changeLeftRightValue()" class="last" id="rightValue">'+ result.right_sep_nm+'('+result.right_sep_unit+','+result.sep_map_right_sep_unit+')</a>'
