...
<head>
	...
	<script src="/js/board/qnaWrite.js"></script>
						...
						<div class="tab_contents">
							<div class="qna_list">
								...
								<div id="qna_input_form" class="board_qna" >
										...
										<tbody>
											...
											<tr>
												...
												<td class="code" valign="middle">
													...
													<img id="thema_regist_secret_code_show" src="/jcaptcha" style="margin-left: 10px; vertical-align: middle;display: none;" alt="보안코드"/>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="content">
													<textarea id="qna_regist_content_input" name="message" style="width: 670px; height: 186px; padding-left: 10px;" ></textarea>
												</td>
											</tr>
											<tr>
												...
												<td class="file">
													...
													<div class="file_input_div" style="width:400px;">
														<input type="button" value="파일찾기" class="file_input_button" style="cursor: pointer;" onclick="javascript:qnaWrite.openFileBrowser();"/>
														<input id="qna_file" class="file_input_hidden" type="file" name="qna_file" style="cursor: pointer;" onchange="javascript:qnaWrite.setFileName(this.value)">
											...
											<tr hidden id="qnaFileTr">
												...
												<td>
													...
													<img src="/img/pm/btn_layer_close.gif" style="cursor: pointer; margin-left: 20px;" onclick="javascript:qnaWrite.removeFileOnModifyMode();" alt="파일삭제"/>
									...
									<div class="btn_board">
										<a id="qnaRegistBtn" class="anc-btn" style="width: 140px; cursor: pointer;" onclick="javascript:qnaWrite.checkSecretCode();">질문등록</a>
									</div>
								</div>
								<!-- //(board_qna) -->
							</div>
