...
<head>
	...
	<script src="/js/board/themaWrite.js"></script>
	...
	<div id="wrap">
		...
		<div id="container">
			<p class="path">
                   ...
                   <a href="/view/board/qnaAndRequest"><span class="path_el current">등록</span></a>
			</p>
										...
										<tbody>
											<tr>
												...
												<td class="code" valign="middle">
													...
													<img id="thema_regist_secret_code_show" src="/jcaptcha" style="margin-left: 10px; vertical-align: middle;display: none;"/>
													<img id="qna_regist_secret_code_show" src="/jcaptcha" style="margin-left: 10px; vertical-align: middle;"/>
												</td>
...
<!-- 												</td> -->
											...
											<tr>
												...
												<td class="content">
													<textarea id="thema_regist_content_input" name="message" style="width: 670px; height: 186px; padding-left: 10px;" ></textarea>
												</td>
											</tr>
											<tr>
												...
												<td class="file">
													...
													<div class="file_input_div" style="width:400px;">
														<input type="button" value="파일찾기" class="file_input_button" style="cursor: pointer;" onclick="javascript:themaWrite.openFileBrowser();"/>
														<input id="thema_file" class="file_input_hidden" type="file" name="qna_file" style="cursor: pointer;" onchange="javascript:themaWrite.setFileName(this.value)">
											...
											<tr hidden id="themaFileTr">
												...
												<td>
													...
													<img src="/img/pm/btn_layer_close.gif" style="cursor: pointer; margin-left: 20px;" onclick="javascript:themaWrite.removeFileOnModifyMode();"/>
									...
									<div class="btn_board">
										<a id="themaRegistBtn" class="anc-btn" style="width: 140px; cursor: pointer;" onclick="javascript:themaWrite.checkSecretCode();">질문등록</a>
									</div>
								</div>
								<!-- //(board_thema) -->
