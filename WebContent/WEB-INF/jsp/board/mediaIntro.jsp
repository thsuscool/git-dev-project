<%
/**************************************************************************************************************************
* Program Name  : 언론소개자료 상세화면 JSP  
* File Name     : mediaIntro.jsp
* Comment       : 
* History       : 네이버시스템 이경현 2016-10-17
*
**************************************************************************************************************************/
%>
...
<html lang="ko">
    <head>
        ...
        <script src="/js/board/mediaIntro.js"></script>
            ...
            <div id="container">
                <p class="path">
                    ...
                    <a href="/view/board/sopBoardMain"><span class="path_el">알림마당&nbsp;&nbsp;>&nbsp;</span></a>
                     -->
                    <a href="/view/board/mediaIntro"><span class="path_el current">언론소개자료</span></a>
                </p>
                ...
                <div class="board_tabs">
                    <a id="board_tabs_notice" href="#" class="active" style="width:100%">언론소개자료</a>
                    <!-- 
