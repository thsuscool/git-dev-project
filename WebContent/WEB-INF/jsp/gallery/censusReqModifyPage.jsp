...
<title>메인 | 통계청SGIS 오픈플랫폼</title>
    ...
    <script type="text/javascript" src="/js/gallery/censusReqModify.js"></script>
	...
	<script>
	 	...
	 	$censusReqModify.mainData = JSON.parse(jsonStringData);
	 	$censusReqModify.data_id = data_id;
		$censusReqModify.img_id =img_id; 
		$censusReqModify.galleryData = JSON.parse(galleryData.replace(/\n/g, "\\n").replace(/\r/g, "\\r").replace(/\t/g, "\\t").replace(/\f/g, "\\f"));
	</script>
</head>
	...
	<div id="wrap">
		...
		<!-- body -->
			...
			<p class="mpGuide">
				...
				<a href="/view/gallery/getUseCaseModifyPage?id=<%=data_id%>"><span class="path_el current">자료수정</span></a>
			</p>
			...
			<div class="useArea">
				...
				<div class="useWrite">
					<table>
						...
						<tr>
							<td colspan="2"><input id="title" type="text" class="inp full" placeHolder="제목을 입력하세요" maxlength="40"/></td>
						</tr>
						<tr>
							<th>활용자명</th>
						...
						<tr>
							<th>이용자료(통계청)</th>
							<td><input id="dataUse1" type="text" class="inp t01" maxlength="40"/></td>
						</tr>
						<tr>
							<th>이용자료(타기관)</th>
							<td><input id="dataUse2" type="text" class="inp t01" maxlength="40"/></td>
						</tr>
						<tr>
							<th>주요 활용내용</th>
				...
				<div class="useSide">
					...
					<input type="file" name="preView" class="hidden" id="imgFile" onchange="$censusReqModify.imageUploadAndPreView(this);" />
					...
					<p class="usSubj">
						...
						<a onclick="$censusReqModify.referenceFileEvent()">첨부파일추가</a>
					...
					<div class="josaListBox">
						<div id="surveyDetail" class="josaListBoxScroll" >
							<ul id="surveyDetailUl">
								...
								<li id="surveyAdd_1"><a onclick="javascript:$censusReqModify.addPollDetail(1);">+ 항목추가</a></li>
							</ul> 
						</div>
			...
			<div class="btnbox ar">
				<a onclick="javascript:$censusReqModify.saveFormSubmit();" class="gbtnType01">등록</a>
			</div>
