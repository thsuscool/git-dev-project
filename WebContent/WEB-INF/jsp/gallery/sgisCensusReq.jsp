				...
				<div class="gcLeft t01">
					<div class="gdTitle">
						...
						<div class="t02">
							...
							<p class="s02">
								<a onclick="javascript:collectionGallery.getCensusReqModifyPage();"><img src="/img/ico/ico_edit01.png" alt="수정" /></a>
						...
						<div style="width:100%;margin:auto 0">
							<table style="margin:auto;width:270px;height:30px;margin-top:10px">
								<tr style="height:30px;line-height:1px;">
									<td valign="middle">
										<a onclick="javascript:$interactiveMap.ui.shareToKakaoStory();" style="margin-left:10px;"><img src="/img/im/kakao.png" alt="카카오스토리"></a>
									</td>
									<td valign="middle">
