...
<body>
	<!--  팝업 -->
	<div class="dialogGtype"  id="" style="display:none;"> <!-- 2017.03.22 갤러리 선택 시, 무한로딩되는 현상  -->
		<div class="popGalleryCreateRela viewType">
			<div class="popGalleryCreate">
				<div class="gcLeft t01">
					...
					<a onclick="javascript:collectionGallery.preViewDownLoad();" class="gvDownloadPreView" style="z-index:20002"><img src="/img/ico/ico_down05.png" alt="다운로드" /></a>
					...
					<div class="gvSlideBox" id="imgSlideBox" style="width:602px;height:67px;">
						...
						<div class="gvController">
							<a onclick="javascript:collectionGallery.playGallery();" class="gvPlay" style="cursor:pointer;"><img src="/img/ico/ico_play.png" alt="재생" /></a>
							<a onclick="javascript:collectionGallery.stopPlay();" class="gvStop" style="cursor:pointer;"><img src="/img/ico/ico_stop.png" alt="멈춤" /></a>
						</div>
				...
				<div class="useSide t01">
					...
					<div class="gvInfo">
						...
						<a onclick="javascript:$collectionModify.modifyData();collectionGallery.stopPlay();"><img src="/img/ico/ico_edit01.png" alt="수정" /></a>
					</div> 
			...
			<a onclick="javascript:collectionGallery.stopPlay();collectionGallery.selectGalleryList();" class="rightClose"><img src="/img/ico/ico_close06.png" /></a>
		</div>
