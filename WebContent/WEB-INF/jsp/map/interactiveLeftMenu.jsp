...
<%@ page import="java.util.ArrayList" %>
				...
				<!-- 1Depth Start -->
					<div class="quickBox step01"><!-- 대화형통계지도 메뉴 보기 start -->
						<div class="subj">
							<!-- mng_s 20170908_김건민 -->
							<span>대화형 통계지도 메뉴 보기</span>
							<!-- mng_e 20170908_김건민 -->
							<a href="javascript:void(0)" class="stepClose" onclick="$interactiveLeftMenu.ui.sqlListBoxPosition2('0px');">닫기</a>
						</div> 
						<div class="scrollBox" id="depth1Menu">
							<dl class="qmdl"> 
								<dd>
									<ul class="qmIcon01">
										...
										<li id="gridHideLeftBtn01" onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('3f');"><span><a data-subj="농림어업총조사" title="${paramInfo.tooltipList.A0201}">농림어업총조사</a></span></li>
							...
							<dl id="gridHideLeftBtn02" class="qmdl" > 
								<dd>
									<ul class="qmIcon03">
										...
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('publicData');"><span><a data-subj="공공데이터" title="${paramInfo.tooltipList.A0501}">공공데이터</a></span></li>
							...
							<ul id="gridHideLeftBtn03" class="qmlist">
<!-- 						<ul id="gridHideLeftBtn03" class="qmlist botn"> -->
	                            ...
	                            <li><a href="/view/newhelp/in_help_10_0" target="_blank">도움말 보기</a></li> 
	                        </ul> 
							<ul id="gridHideLeftBtn04" class="qmlist botn">
	                            <li style="margin-left:10px;font-size:14px;">집계구 위치 찾기</li>
	                            <li><input id="outputArea" style="width:150px; margin-left:10px;" type="text" placeholder="집계구번호 입력"/>
	                            <input type="button" value="검색" style="width:50px;" onclick="$interactiveLeftMenu.event.outputAreaSearch();"/></li>
	                            <li style="margin-left:10px;">ex) 2503060010001</li>
	                        </ul> 
						</div> 
						<!-- 
					...
					<div class="quickBox step02" id="quickBox_2depth">
						<div class="subj">
							...
							<a href="javascript:void(0)" class="stepClose" onclick="$interactiveLeftMenu.ui.sqlListBoxPosition2('280px');">닫기</a>
						</div>
						<div class="scrollBox">
							...
							<div class="totalResult tr02"><!-- 인구주택총조사 통계 -->
								<ol class="cateMenu type01" id="populationTabDiv">
	                                ...
	                                <li id="gridHideCombineBtn"><a href="javascript:$interactiveLeftMenu.ui.populationTab('combine');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0121}">결합조건</a></li>
	                            </ol>
	                            ...
	                            <div class="cm03 population_tab"  id="API_0306">
									...
									<div class="stepBox"> 
										<a href="javascript:void(0)" class="roundTextBox" id="houseTypeTab">
											...
											<!-- mng_s -->
											<span id="houseTypeTabSpan">주택유형(다중선택)</span>
											<span id="houseTypeTabGrid" style="display:none;">주택유형(단일선택)</span>
										</a>
										<!-- 
...
<!-- 									    </div> -->
							...
							<div class="totalResult tr04">
								<ol class="cateMenu" id="companyTabDiv">
	                                ...
	                                <li id="gridCompanyThemaHide"><a href="javascript:$interactiveLeftMenu.ui.companyTab('theme');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0303}">테마업종</a></li>
	                            </ol>
	                            ...
	                            <div class="cm01 company_tab" id="API_0304-b">
	                            	<div class="stepBox">
										<p class="on">조사년도(필수)
											<select title="사업체 조사년도" id="company_year" name="company_year" style="font-size:13px;" onchange="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('company2');">
									        </select>
										</p>
									    <!-- <ul>
									        <li>
	                            	...
	                            	<div class="stepBox">
									    <ul>
									        ...
									        <li style="height: auto; text-align: right; padding-top: 5px; margin-bottom: -8px;">
									        	<img src="/img/ico/kosis_gis_se_sido.png" style="vertical-align: middle;" alt="시도" > : 시도 </img>
									        	<img src="/img/ico/kosis_gis_se_sgg.png" style="vertical-align: middle;"  alt="시군구" > : 시군구 </img>
									        	<img src="/img/ico/kosis_gis_se_adm.png" style="vertical-align: middle;"  alt="읍면동" > : 읍면동 </img>
									        </li>
									    </ul>
									</div>
									<!-- kosis 리스트 -->
						...
						@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
						 -->
						<div class="btnBottom" style="margin-left:20px;">
					...
					<div class="quickBox step03" id="companyClassListDiv">
	                    ...
	                    <div class="menuAutoClose" style="bottom:10px;">
							<input type="radio" name="menuAutoClose_radio" id="menuAutoClose_radio2" checked="checked" onclick="$interactiveLeftMenu.ui.sqlListBoxPosition2('840px');"/>
					...
					<div class="quickBox step03" id="kosisDetailDiv">
	                    ...
	                    <div class="menuAutoClose" style="bottom:10px;" id="menuAutoClose4Lev">
							<input type="radio" name="menuAutoClose_radio" id="menuAutoClose_radio3" checked="checked" onclick="$interactiveLeftMenu.ui.sqlListBoxPosition2('840px');"/>
				            <label for="menuAutoClose_radio3" class="on">자동닫기</label>
						</div>
					</div>
					<!-- 해당분류 세부업종 선택하기 end -->