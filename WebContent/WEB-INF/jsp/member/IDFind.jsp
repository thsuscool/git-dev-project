<%
/**************************************************************************************************************************
* Program Name  : 아이디 찾기 JSP  
* File Name     : IDFind.jsp
* Comment       : 
...
<!-- 	<script type="text/javascript"  src="/softcamp/scwebsc.js"></script> -->
	<div id="wrap">
	    ...
	    <p class="path">
			...
			<a href="/view/member/IDFind"><span class="path_el current">아이디 찾기</span></a>
		</p>
...
<!-- 		//2015-09-10 수정 -->
		...
		<div class="board_tabs board_tabs-quad">
			<span style="width: 50%; cursor: pointer;" class="active"><em>01</em> 아이디 찾기</span>
			<span style="width: 50%; cursor: pointer;"><em>02</em> 비밀번호 찾기</span>
		</div>
<!-- 		//2015-09-10 수정 -->
		<div id="contents">
			<div id="content">
							...
							<table>
								...
								<tbody>
									<tr>
										...
										<td class="name">
											<input value="" type="text" id="member_nm" name="member_nm" style="width: 250px;" maxlength="20" title="이름"/>
										</td>
									</tr>
									<tr>
										<th scope="row"><span>휴대폰</span></th>
										<td class="phone select_box">
											<select class="" id="cp_no1" name="cp_no1" style="width: 99px;" title="전화번호 앞">
												<option>010</option>
												<option>011</option>
												<option>016</option>
												<option>018</option>
											...
											&nbsp;&nbsp;-&nbsp;&nbsp;
											<input type="text" maxLength=4 onkeyup='siche_next()' id="cp_no2" name="cp_no2" style="width: 51px;" title="전화번호 중간" />
											&nbsp;&nbsp;-&nbsp;&nbsp;
											<input type="text" maxLength=4 onkeyup='siche_next()' id="cp_no3" name="cp_no3" style="width: 51px;" data-options="required:true" onkeypress="submitOnEnter(this, event, 0);" title="전화번호 뒤" />											
										</td>
									</tr>																		
								</tbody>
							</table>
							...
							<table>
								...
								<tbody>
									<tr>
										...
										<td class="name">
											<input value="" type="text" id="member_id" name="member_id" style="width: 250px;" maxlength="20" title="아이디"/>
										</td>
									</tr>
									<tr>
										<th scope="row"><span>이름</span></th>
										<td class="name">
											<input value="" type="text" id="member_nm2" name="member_nm2" style="width: 250px;" maxlength="8" title="이름" />
										</td>
									</tr>
									<tr>
										<th scope="row"><span>휴대폰</span></th>
										<td class="phone select_box">
											<select id="cp_no4" name="cp_no4" style="width: 99px;" title="휴대폰 앞">
												<option>010</option>
												<option>011</option>
												<option>016</option>
												<option>018</option>
											...
											&nbsp;&nbsp;-&nbsp;&nbsp;
											<input type="text" id="cp_no5" maxLength=4 onkeyup='siche_next()' name="cp_no5" style="width:51px;" title="휴대폰 중간" />
											&nbsp;&nbsp;-&nbsp;&nbsp;
											<input type="text" id="cp_no6" maxLength=4 onkeyup='siche_next()' name="cp_no6" style="width: 51px;" onkeypress="submitOnEnter(this, event, 1);" title="휴대폰 뒤" />											
										</td>
									</tr>																	
								</tbody>
							</table>
