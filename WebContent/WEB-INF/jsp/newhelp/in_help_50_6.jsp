	...
	<div class="wrapper">
		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/in_help_50_0">서비스 구분별 이용방법</a>
							<ul class="sub">
								...
								<li><a href="/view/newhelp/in_help_50_6" class="on">ㆍ결합통계 조회</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>결합통계 조회</h1>
					<h2>○ 인구, 가구, 주택조건을 결합하여 검색조건 설정이 가능하고, 해당 검색조건의 인구, 가구수, 주택수 기준으로</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;통계를 조회할 수 있습니다.</h2>
					<img src="/img/newhelp/In_050_14.png" alt="결합검색 조건"/>
					<h2 style="margin-left: 220px;">[결합검색 조건]</h2><br>
					<h2>○ 생성된 통계버튼을 더블클릭하거나, 지도화면 임의의 행정구역에 드래그앤드롭 하면 선택된 행정구역의</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;세부행정구역 단위로 해당 결합통계정보가 생성되어 지도화면에 표출됩니다.</h2>
					<img src="/img/newhelp/In_050_15.png" alt="결합통계 검색 결과"/>
					<h2 style="margin-left: 250px;">[결합통계 검색 결과]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
