		...
		<div class="container">
				...
				<div class="leftmenu">
					<ul>
						...
						<li><a href="/view/newhelp/house_help_20_0" class="on">기본조작 방법</a>
							<ul class="sub">
								<li><a href="/view/newhelp/house_help_20_0" class="on">ㆍ지도 표출 및 경계 표출</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>지도 표출 및 경계 표출</h1>
					<ul class="Cont_List">
						<li>살고싶은 우리동네는 총 14단계의 타일맵이 있습니다.
							<ul>
					...
					<figure>
						<img src="/img/newhelp/img_house_2_01.png" style="margin-left: 0px;" alt="전국 경계 표출">
						<figcaption>[전국 경계 표출]</figcaption>
					</figure>

					<h2 class="Type_2">3, 4레벨 ▶ 시/도 경계 표출</h2>
					<figure>
						<img src="/img/newhelp/img_house_2_02.png" style="margin-left: 0px;" alt="시/도 경계 표출">
						<figcaption>[시/도 경계 표출]</figcaption>
					</figure>

					<h2 class="Type_2">5, 6레벨 ▶ 시/군/구 경계 표출</h2>
					<figure>
						<img src="/img/newhelp/img_house_2_03.png" style="margin-left: 0px;" alt="시/군/구 경계 표출">
						<figcaption>[시/군/구 경계 표출]</figcaption>
					</figure>

					<h2 class="Type_2">7, 8, 9레벨 ▶ 읍/면/동 경계 표출</h2>
					<figure>
						<img src="/img/newhelp/img_house_2_04.png" style="margin-left: 0px;" alt="읍/면/동 경계 표출">
						<figcaption>[읍/면/동 경계 표출]</figcaption>
					</figure>

					<h2 class="Type_2">10, 11, 12, 13, 14레벨 ▶ 집계구 경계 표출</h2>
					<figure>
						<img src="/img/newhelp/img_house_2_05.png" style="margin-left: 0px;" alt="집계구 경계 표출">
