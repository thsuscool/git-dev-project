		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/community_help_3_1" class="on">서비스 이용방법</a>
							<ul class="sub">
								...
								<li><a href="/view/newhelp/community_help_3_6" class="on">ㆍ댓글쓰기 및 신고하기</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<figure>
						<img src="/img/newhelp/img_community_3_07.png"	style="width:700px;" alt="소통지도 의견 댓글쓰기 및 신고하기">
					</figure>
					<ol>
						<li>1) 수정 : 의견등록한 내용을 변경합니다.</li>
						<li>2) 삭제 : 등록한 의견을 삭제합니다.</li>
						<li>3) 신고하기 : 등록된 의견에 문제를 입력합니다.</li>
						<li>4) 신고목록 : 신고하기로 접수된 신고내용을 보여줍니다.</li>
						<li>5) 댓글쓰기 : 등록된 의견에 대한 댓글을 입력합니다.</li>
					</ol>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
