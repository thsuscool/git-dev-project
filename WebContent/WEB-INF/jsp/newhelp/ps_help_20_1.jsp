	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="leftWrap">
				...
				<div class="leftmenu">
					<ul>
						...
						<li><a href="/view/newhelp/ps_help_20_0">기본조작 방법</a>
							<ul class="sub">
								<li><a href="/view/newhelp/ps_help_20_0">ㆍ지도 표출 및 경계 표출</a></li>
								<li><a href="/view/newhelp/ps_help_20_1" class="on">ㆍ지도창 조작 방법</a></li>
							</ul>
						</li>							
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>지도창 조작 방법</h1>
					<h2>○ 지도이동은 마우스 드래그 방식으로 동작하고, 지도확대 및 축소는 마우스 휠 조작에 의해서 동작합니다.</h2>
					...
					<img src="/img/newhelp/In_020_7_new.png" style="margin-left: 100px; width:500px;" alt="행정구역으로 이동하는 방법"/>	
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
