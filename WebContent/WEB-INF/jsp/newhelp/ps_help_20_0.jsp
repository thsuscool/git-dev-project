	...
	<div class="wrapper">
		...
		<div class="container">
				...
				<div class="leftmenu">
					<ul>
						...
						<li><a href="/view/newhelp/ps_help_20_0">기본조작 방법</a>
							<ul class="sub">
								<li><a href="/view/newhelp/ps_help_20_0" class="on">ㆍ지도 표출 및 경계 표출</a></li>
								<li><a href="/view/newhelp/ps_help_20_1">ㆍ지도창 조작 방법</a></li>
							</ul>
						</li>							
						<li><a href="/view/newhelp/ps_help_30_0">사례별 이용법</a></li>
					</ul>
				</div>
			</div><!--leftmenu-->
			<!--contents-->
			<div class="contentsWrap">
				<div class="contents">
					<h1>지도 표출 및 경계 표출</h1>
					<h2>○ 정책 통계지도는 총 14단계의 타일맵이 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;지도를 축소/확대 할때에 각 지도 레벨에 해당하는 행정경계 정보가 표출됩니다.</h2>
					<h2>○ 1, 2레벨 ▶ 전국 경계 표출</h2>
					<img src="/img/newhelp/In_020_0_new.png" border=0 alt="전국 경계 표출"/>		
