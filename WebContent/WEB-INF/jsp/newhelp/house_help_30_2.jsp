					...
					<ul>
						...
						<li><a href="/view/newhelp/house_help_30_0" class="on">서비스 이용방법</a>
							<ul class="sub">
								...
								<li><a href="/view/newhelp/house_help_30_2" class="on">ㆍ지표내용</a></li>
							</ul>
						</li>
					</ul>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 환경과학원 미세먼지월별대기오염도(2016년), 이산화질소월별대기오염도(2016년)<br>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 기상청 체감온도(2016년 11월~2017년 3월), 불쾌지수(2017년 6월~9월)
									<br>
							...
							<tr>
								...
								<td>1인당 주거 연면적</td>
								<td>
									주거면적은 주택수준을 확인하기 위해 1인당 살고있는 주거 면적을 확인할 수 있는 지표입니다. 2016 인구주택총조사 총 인구 대비 주거 연면적을 행정구역 별로 보실 수 있습니다.
									<br><br>
									
									※ 출처 : 통계청 인구주택총조사(2016년)
									<br>
									※ 산출식 : 주거 연면적 / 총 인구
								</td>
								<td>총 인구에서 외국인, 기숙사, 군부대 거주자는 제외</td>
								<td>읍면동</td>
								<td>통계청 인구주택총조사(2016년)</td>
							</tr>
							<tr>
								<td>노후주택비율</td>
							...
							<tr>
								...
								<td>
									자가점유비율은 가구 수에 비해 주택 수가 얼마나 여유있는지 아니면 부족한지를 확인할 수 있는 지표입니다. 일반 가구 중 자신이 소유한 주택에서 자신이 살고 있는 주택의 비율을 의미하며, 2016 인구주택총조사 총 주택 대비 자가점유 비율을 행정구역 별로 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 국토교통부 주택실거래가(2016년1월1일~2017년6월30일)
									<br>
									※ 산출식 : 아파트 가격 / 아파트 면적
								</td>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 통계청 등록센서스(2016년), 통계청 전국사업체조사(2016년)<br>
							...
							<tr>
								...
								<td>범죄 안전지수(등급)</td>
								<td>
									범죄 위험지역을 1~5등급으로 구분하여 발표한 국민안전처 범죄안전지수를 바탕으로 범죄안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 범죄안전 수준을 나타내는 범죄안전지수(등급)를 보실 수 있습니다.
									<br><br>
									
									※ 출처 : 국민안전처 범죄 안전지수(2016년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>안전 사고지수(등급)</td>
								<td>
									안전사고 위험지역을 1~5등급으로 구분하여 발표한 국민안전처 안전사고지수를 바탕으로 안전사고에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 안전사고 수준을 나타내는 안전사고지수(등급)를 보실 수 있습니다.
									<br><br>
									
									※ 출처 : 국민안전처 안전 사고지수(2016년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>자살 안전지수(등급)</td>
								<td>
									자살 위험지역을 1~5등급으로 구분하여 발표한 국민안전처 자살안전지수를 바탕으로 자살안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 자살안전 수준을 나타내는 자살안전지수(등급)를 보실 수 있습니다.
									<br><br>

									※ 출처 : 국민안전처 자살 안전지수(2015년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>감염병 안전지수(등급)</td>
								<td>
									감염병 위험지역을 1~5등급으로 구분하여 발표한 국민안전처 감염병안전지수를 바탕으로 감염병안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 감염병안전 수준을 나타내는 감염병안전지수(등급)를 보실 수 있습니다.
									<br><br>

									※ 출처 : 국민안전처 감염병 안전지수(2016년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>자연재해 안전지수(등급)</td>
								<td>
									자연재해 위험지역을 1~5등급으로 구분하여 발표한 국민안전처 자연재해안전지수를 바탕으로 자연재해안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 자연재해안전 수준을 나타내는 자연재해안전지수(등급)를 보실 수 있습니다.
									<br><br>
									
									※ 출처 : 국민안전처 자연재해 안전지수(2016년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>2015년 인구주택총조사 10%표본 자료로서 2015년 행정구역 경계와 상이 할 수 있습니다.</td>
								<td>시군구</td>
...
<!-- 									※ 출처 : 국토교통부 버스정류장 위치현황(2011년, 2016년6월), 지자체 지하철 현황(2015년) -->
<!-- 								</td> -->
...
<!-- 							</tr> -->
							<tr>
								<td rowspan="3">교육</td>
								<td>교원 1인당 학생 수 </td>
								<td>초중고 교원 1인당 학생 수 </td>
								<td>
									교원 1인당 학생 수는 초중고등학교 교원 1인당 학생 수를 확인할 수 있는 지표입니다. 초중고 교원 1인이 담당하는 학생 수를 행정구역 별로 보실 수 있습니다.
									<br><br>
									
									※ 출처 : 한국교육개발원 교육통계연구센터, 교원 1인당 학생 수 현황(2016년)
									<br>
									※ 산출식 : 총 학생 수 / 교원 수
								</td>
								<td>-</td>
							...
							<tr>
								<td rowspan="5">복지 문화</td>
								<td>유치원 및 보육시설</td>
								<td>보육시설 기관 대비 5세 미만 인구</td>
								<td>
									...
									※ 출처 : 통계청 등록센서스(2016년), 통계청 전국사업체조사(2016년)
									<br>
							...
							<tr>
								...
								<td>문화 체육 기반시설 수</td>
								<td>
									문화체육시설은 지역별 문화 수준을 확인할 수 있는 지표입니다. 극장 영화관 등의 문화시설과 체육공원 스포츠 서비스업 등의 체육시설 수를 행정구역 별로 보실 수 있습니다.
									<br><br>
