		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/tc_help_20_0">기본조작 방법</a>
							<ul class="sub">
						        ...
						        <li><a href="/view/newhelp/tc_help_20_9" class="on">ㆍ데이터 업로드 이용방법</a></li>
							</ul>
						</li>							
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h2>○ 통계메뉴 버튼을 누릅니다.</h2>
					<img src="/img/newhelp/In_020_22_new.png"  style="margin-left: 55px; width:350px;" alt="데이터 업로드"/>
					<br><br>
					<h2>○ 나의 데이터 메뉴를 선택합니다.</h2>
					<img src="/img/newhelp/In_020_23_new.png"  style="margin-left: 55px; width:350px;" alt="데이터 업로드 파일선택"/>	
					<br><br>
					...
					<img src="/img/newhelp/In_020_25_new.png"  style="margin-left: 35px; width:600px;" alt="데이터 업로드 파일선택"/>	
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
