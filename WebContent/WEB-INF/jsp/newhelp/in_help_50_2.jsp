		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<img src="/img/newhelp/In_050_6_re.png" style="margin-left: 60px; width:500px;" alt="주택검색 조건"/>	
					<h2 style="margin-left: 250px;">[주택검색 조건]</h2><br>
					...
					<h2 style="margin-left: 300px;">[주택통계 검색 결과]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
