...
<!-- 	<script type="text/javascript" src="/js/plugins/colResizable-1.5.min.js"></script> -->
    ...
    <script type="text/javascript" src="/js/thematicMap/thematicEtc03.js"></script>
    ...
    <script type="text/javascript" src="/js/thematicMap/thematicMapFrame03.js"></script><!-- *신규* -->
...
<!-- 							<a href="javascript:$thematicMapFrame03.ui.mapList[0].mapNavigation.getLocation();" class="interactiveIco"><img src="/img/ico/ico_gps01.gif" alt="위치검색" /></a>  -->
							...
							<div class="tb_right"> 
								<ul class="tbr01">   
									...
									<li><a onclick="javascript:$thematicMapFrame03.ui.reportDataSet(1);" style="cursor:pointer;" title="보고서 보기"><img src="/img/ico/ico_toolbars06.png" alt="보고서 보기" /></a></li>
		    	...
		    	<div class="sqListBox sq03">
		    		...
		    		<div class="sqList">
		    			<ul>
		    				<li id="stat_sel">
		    					<span>통계선택</span>
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeLeftRightValue()" class="first" id="leftValue">증감틀</a> -->
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    					<input type="hidden" id="selectValue" value=""/>
		    				</li>
		    				<li id="region_boundary">		
		    					<span>지역경계</span>
		    					<a href="javascript:$thematicMapFrame03.Popup.show();$thematicMapFrame03.ui.mapList[0].changeRegionBound()" class="first" id="autoRegion">자동</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show();$thematicMapFrame03.ui.mapList[0].changeRegionBound()" id="sido" style="width:90px;">시도별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show();$thematicMapFrame03.ui.mapList[0].changeRegionBound()" id="sigungu" style="width:100px;">시군구별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show();$thematicMapFrame03.ui.mapList[0].changeRegionBound()" id="eupmyundong" class="last" style="width:100px;">읍면동별 전국지도</a>
		    					<input type="hidden" id="selectValue2" value="auto"/>
		    				</li>
		    				<li id="map_type">
		    					<span>지도유형</span>
		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" class="first on" id="color">색상</a>
		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" class="last">버블</a>
		    					<input type="hidden" id="dataMode" value="color"/>
		    				</li> 
		    				<li id="heritage_type" style="display: none;">
		    					<span>지도유형</span>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].changeRegionBound()" style="width: 130px;" class="first" id="heritage0">국가지정문화재 지정구역</a>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].changeRegionBound()" class="last">등록문화재</a>
		    					<input type="hidden" id="heritageMode" value="0"/>
		    				</li>
		    				<li id="data_type">
		    					<span>통계표출</span>
		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode2()" class="first">ON</a>
		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode2()" class="last" id="default_switch">OFF</a>
					...
					<div class="quickBox step01"><!-- 주제별 목록보기 start -->
						...
						<div class="scrollBox">							
							...
							<ul class="qmlist botn">
	                            ...
	                            <li><a onclick="javascript:$thematicMapFrame03.ui.reportDataSet(1);" style="cursor:pointer;">보고서 보기</a></li>
...
<!-- 		                </div>  -->
		...
		<div id="bookmarkdlg" class="popBox" style="display: none; z-index: 20001;">
			<div class="topbar">
				...
				<a onclick="javascript:$thematicMapFrame03.ui.doCancel('bookmarkdlg');">닫기</a>
			</div>
			<div class="popContents">
				...
				<div class="btnBox">
					<a onclick="javascript:$thematicMapFrame03.ui.doDone('bookmarkdlg');" class="btnStyle01">My Page 저장</a> 
					<a onclick="javascript:$thematicMapFrame03.ui.doCancel('bookmarkdlg');" class="btnStyle01">닫기</a>
				</div>
		 	</div>
	    </div>
		...
		<div id="myGalleryPop" style="display: none; z-index: 20000;" class="popBox">
			...
			<div class="popContents">
				...
				<div class="btnBox">
					...
					<a href="javascript:$thematicMapFrame03.ui.doBookMark(1, 'THEME');" class="btnGtype">즐겨찾기</a> 
