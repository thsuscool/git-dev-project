...
<head>
    ...
    <script type="text/javascript"  src="/js/thematicMap/map05.js"></script>
    ...
    <script type="text/javascript" src="/js/thematicMap/thematicEtc05.js"></script>
    ...
    <script type="text/javascript" src="/js/thematicMap/thematicMapFrame05.js"></script><!-- *신규* -->
...
<!-- 							<a href="javascript:$thematicMapFrame05.ui.mapList[0].mapNavigation.getLocation();" class="interactiveIco"><img src="/img/ico/ico_gps01.gif" alt="위치검색" /></a>  -->
							...
							<div class="tb_right"> 
								<ul class="tbr01">   
									...
									<li><a onclick="javascript:$thematicMapFrame05.ui.reportDataSet(1);" style="cursor:pointer;" title="보고서 보기"><img src="/img/ico/ico_toolbars06.png" alt="보고서 보기" /></a></li>
...
<!-- 		    					<a href="javascript:$thematicMapFrame05.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    				...
		    				<li id="region_boundary">		
		    					<span>지역경계</span>
		    					<a href="javascript:$thematicMapFrame05.Popup.show();$thematicMapFrame05.ui.mapList[0].changeRegionBound()" class="first" id="autoRegion">자동</a>
		    					<a href="javascript:$thematicMapFrame05.Popup.show();$thematicMapFrame05.ui.mapList[0].changeRegionBound()" id="sido" style="width:90px;">시도별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame05.Popup.show();$thematicMapFrame05.ui.mapList[0].changeRegionBound()" id="sigungu" style="width:100px;">시군구별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame05.Popup.show();$thematicMapFrame05.ui.mapList[0].changeRegionBound()" id="eupmyundong" class="last" style="width:100px;">읍면동별 전국지도</a>
		    					<input type="hidden" id="selectValue2" value="auto"/>
		    				</li>
		    				<li id="map_type">
		    					<span>지도유형</span>
		    					<a href="javascript:$thematicMapFrame05.ui.changeDataMode()" class="first" id="color">색상</a>
		    					<a href="javascript:$thematicMapFrame05.ui.changeDataMode()" class="last">버블</a>
		    					<input type="hidden" id="dataMode" value="color"/>
		    				</li> 
		    				<li id="data_type">
		    					<span>통계표출</span>
		    					<a href="javascript:$thematicMapFrame05.ui.changeDataMode2()" class="first">ON</a>
		    					<a href="javascript:$thematicMapFrame05.ui.changeDataMode2()" class="last" id="default_switch">OFF</a>
		    					<input type="hidden" id="dataMode2" value="dataOff"/>
		    				</li>
		    				<!-- 2016.07.11 시계열 추가  -->
		    				<li id="timeSeries_type" style="display: none;">
		    					<span>시계열조회</span>
		    					<a href="javascript:$thematicMapFrame05.Popup.show();javascript:$thematicMapFrame05.ui.timeSeriesPlay(true)" class="first" style="margin-left:-12px;">ON</a>
