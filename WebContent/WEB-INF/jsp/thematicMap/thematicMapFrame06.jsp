...
<head>
    ...
    <script type="text/javascript"  src="/js/thematicMap/map06.js"></script>
	...
	<script type="text/javascript" src="/js/thematicMap/thematicEtc06.js"></script> 
...
<!--     <script type="text/javascript" src="/js/thematicMap/thematicMapFrame03_api.js"></script> -->
    <script type="text/javascript" src="/js/thematicMap/thematicMapFrame06.js"></script><!-- *신규* -->
		...
		<div class="containerBox">  
			<div class="rela">
				...
				<div class="toolBar">
					...
					<div class="tb_right"> 
						<ul class="tbr01">   
							...
							<li><a onclick="javascript:$thematicMapFrame06.ui.reportDataSet(1);" style="cursor:pointer;" title="보고서 보기"><img src="/img/ico/ico_toolbars06.png" alt="보고서 보기" /></a></li>
				...
				<div class="interactiveBar">
				    <p class="helperText">
				    	<a href="javascript:void(0)" data-subj="주제도 설명" title=""><img src="/img/ico/ico_i.gif" alt="주제도 설명" /></a>
				    </p> 
				</div>
					<!--지도 view 1 -->
...
<!-- 		    					<a href="javascript:$thematicMapFrame06.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    				...
		    				<li id="region_boundary">		
		    					<span>지역경계</span>
		    					<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.mapList[0].changeRegionBound();$thematicMapFrame06.ui.mapList[1].changeRegionBound();" class="first" id="autoRegion">자동</a>
		    					<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.mapList[0].changeRegionBound();$thematicMapFrame06.ui.mapList[1].changeRegionBound();" id="sido" style="width:90px;">시도별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.mapList[0].changeRegionBound();$thematicMapFrame06.ui.mapList[1].changeRegionBound();" id="sigungu" style="width:100px;">시군구별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame06.Popup.show();$thematicMapFrame06.ui.mapList[0].changeRegionBound();$thematicMapFrame06.ui.mapList[1].changeRegionBound();" id="eupmyundong" class="last" style="width:100px;">읍면동별 전국지도</a>
		    					<input type="hidden" id="selectValue2" value="auto"/>
		    				</li>
		    				<li id="map_type">
		    					<span>지도유형</span>
		    					<a href="javascript:$thematicMapFrame06.ui.changeDataMode()" class="first" id="color">색상</a>
		    					<a href="javascript:$thematicMapFrame06.ui.changeDataMode()" class="last">버블</a>
		    					<input type="hidden" id="dataMode" value="color"/>
		    				</li> 
		    				<li id="data_type">
		    					<span>통계표출</span>
		    					<a href="javascript:$thematicMapFrame06.ui.changeDataMode2()" class="first">ON</a>
		    					<a href="javascript:$thematicMapFrame06.ui.changeDataMode2()" class="last" id="default_switch">OFF</a>
