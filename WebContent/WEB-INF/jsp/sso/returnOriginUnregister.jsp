<%
/**************************************************************************************************************************
* Program Name  : 기존회원탈퇴 결과 수신 JSP  
* File Name     : returnOriginUnregister.jsp
* Comment       : 
	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#successOriginUnRegisterForm").attr("target", "_parent");
				$("#successOriginUnRegisterForm").submit();
			});
		</script>
	</head>
	<body>
		<form action="<%=strCurUrl %>" method="post" id="successOriginUnRegisterForm" name="successOriginUnRegisterForm">
		</form>
	</body>
	</html>