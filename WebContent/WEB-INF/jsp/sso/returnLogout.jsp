<%
/**************************************************************************************************************************
* Program Name  : 로그아웃 결과 수신 JSP  
* File Name     : returnLogout.jsp
* Comment       : 
	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				if(parent.logoutCurUrl){
					$("#successLogoutForm").attr("action",parent.logoutCurUrl);
				}else{
					$("#successLogoutForm").attr("action","<%=strCurUrl %>");
				}
				$("#successLogoutForm").attr("target", "_parent");
				$("#successLogoutForm").submit();
			});
		</script>
	</head>
	<body>
		<form action="" method="post" id="successLogoutForm" name="successLogoutForm">
		</form>
	</body>
	</html>