	...
	<body>  
		<div id="wrap">
			<div class="containerBox">
				<div class="FuseResult_layer">
					<div class="FuseResult">
						<div id="policy-popup-header" style="border-bottom:#036 solid 1px;">
							<h3 id="combineTitle"><span>융합결과</span></h3>
							<button id="closePopup" class="btn_close" type="button">창닫기</button>
						</div>
						<div class="FR_MapArea" id="mapRgn"></div>
						<div id="step1" class="FR_Data">
							<ul class="Tab">
								<li id="0" style="display:none;"><a href="javascript:void(0);">정책통계지도 설명</a></li>
								<li class="M_on" id="1"><a href="javascript:void(0);">기준/추가 데이터</a></li>
								<li id="2"><a href="javascript:void(0);">융합데이터</a></li>
							</ul>
							<div class="DataBox FR_single" style="width:100%">
								...
								<div class="DataBoxScroll" style="height:350px;">
									<div class="Chart" id="targetOpenerCharts"></div>
								</div>
							</div>
							<div class="DataBox FR_fuse" style="display:none; width:100%;">
								<div class="FR_Basic">
									<ul>
										<li id="combineMenu"><span>주요지표</span></li>
										<li id="combineSidoSgg"><span>대상지역</span></li>
										<li id="combineorigin"><span>출처</span></li>
									</ul>
								</div>
								<div class="DataBoxScroll" style="height:350px;">
