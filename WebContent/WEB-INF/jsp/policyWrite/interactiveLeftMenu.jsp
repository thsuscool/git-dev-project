...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
				...
				<!-- 1Depth Start -->
					<div class="quickBox step01" id="quickBox-01"><!-- 대화형통계지도 메뉴 보기 start -->
						<div class="subj">
							<span>대화형통계지도 메뉴 보기</span>
							<a href="javascript:void(0)" id="stepClose-left01" class="stepClose">닫기</a>
						</div>
						<div class="cont_policy">
							<dl class="SetArea">
								<dt><label for="sido-select"><span id="sido_sgg_choice">지역선택</span></label></dt>
								<dd>
									<select id="sido-select" data-type="current" title="지역선택 시도 선택">
										<option value="00">전국</option>
									</select>
									<select id="sgg-select" title="지역선택 시군구 선택">
										<option value="999">전체</option>
									</select>
									<select id="emdong-select" title="지역선택 시군구 선택">
						...
						<div class="scrollBox" id="depth1Menu">
							<dl class="qmdl"> 
								<dd>
									<ul class="qmIcon01">
										<li id="mainIndexBtn" onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('mainIndex');"><span><a data-subj="총조사주요지표" title="${paramInfo.tooltipList.A0001}">총조사 주요지표</a></span></li>
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('populationHouse');"><span><a data-subj="인구주택총조사" title="${paramInfo.tooltipList.A0102}">인구주택총조사</a></span></li>
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('3f');"><span><a data-subj="농림어업총조사" title="${paramInfo.tooltipList.A0201}">농림어업총조사</a></span></li>
										<li id="companyBtn" onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('company');"><span><a data-subj="전국사업체조사" title="${paramInfo.tooltipList.A0301}">전국사업체조사</a></span></li>
									</ul>
								</dd>
							</dl> 
							<dl class="qmdl"> 
								<dd>
									<ul class="qmIcon03">
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('kosis');"><span><a data-subj="KOSIS(지역통계)" title="${paramInfo.tooltipList.A0401}">KOSIS(지역통계)</a></span></li>
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('userData');"><span><a data-subj="나의 데이터" title="${paramInfo.tooltipList.A0601}">나의 데이터</a></span></li>
									</ul>
								</dd>
							</dl>
							<dl class="qmdl">
								<dd>
									<ul class="qmIcon03">
										<li onclick="javascript:$interactiveLeftMenu.ui.setDetailStatsPanel('local');"><span><a data-subj="협업형데이터" title="">협업형 데이터</a></span></li>
									</ul>
								</dd>
							</dl>
						</div>
						...
						<div class="scrollBox">
								    ...
								    <p class="on">주요지표
								   	...
								   	<ul class="dbTypeCk">
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0002}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio02" value="avg_age" />
								            <label for="mainIndex_radio02">평균나이(세)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0003}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio03" value="ppltn_dnsty" />
								            <label for="mainIndex_radio03">인구밀도(명/㎢)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0004}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio04" value="aged_child_idx" />
								            <label for="mainIndex_radio04">노령화지수</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0005}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio05" value="oldage_suprt_per" />
								            <label for="mainIndex_radio05">노년부양비</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0006}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio06" value="juv_suprt_per" />
								            <label for="mainIndex_radio06">유년부양비</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0007}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio07" value="tot_family" />
								            <label for="mainIndex_radio07">가구(가구)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0008}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0009}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio09" value="tot_house" />
								            <label for="mainIndex_radio09">주택(호)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0010}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
									</ul>
								</div>
								<div class="stepBox mainIndex_stepBox" id="mainIndex_box2" style="display:none;"> <!-- 2016.08.23 권차욱 9월서비스  -->
							  		<ul class="dbTypeCk mt10">
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0011}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio11" value="nongga_ppltn" />
								            <label for="mainIndex_radio11">농가인구_계(명)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0012}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio12" value="imga_cnt" />
								            <label for="mainIndex_radio12">임가(가구)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0013}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio13" value="imga_ppltn" />
								            <label for="mainIndex_radio13">임가인구_계(명)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0014}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio14" value="naesuoga_cnt" />
								            <label for="mainIndex_radio14">내수면총어가(가구)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0015}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0016}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            <input type="radio" name="mainIndex_radio" id="mainIndex_radio16" value="haesuoga_cnt" />
								            <label for="mainIndex_radio16">해수면총어가(가구)</label>
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0017}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0018}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li>
								 	</ul>
								</div>
								<div class="stepBox mainIndex_stepBox"> 
								    ...
								    <ul class="dbTypeCk mt10">
								        <li>
								            ...
								            <a href="javascript:void(0)" class="ar" data-subj="주요지표" title="${paramInfo.tooltipList.A0019}"><img src="/img/ico/ico_tooltip01.png" /></a>
								        </li> 
								    </ul> 
								</div>
							</div>
							...
							<div class="totalResult tr02"><!-- 인구주택총조사 통계 -->
								<ol class="cateMenu type01" id="populationTabDiv">
	                                <li class="on"><a href="javascript:$interactiveLeftMenu.ui.populationTab('population');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0101}">인구조건</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.populationTab('household');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0103}">가구조건</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.populationTab('house');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0114}">주택조건</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.populationTab('combine');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0121}">결합조건</a></li>
	                            </ol>
									    ...
									    <div class="joinDefault">
									    	<ul class="multiCheckBox" style="overflow:visible;"> <!-- 2016.08.23 권차욱 9월 서비스  -->
										        <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="1세대 가구" title="${paramInfo.tooltipList.A0104}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_household02" name="household_type" value="02" />
										            <label for="rd_household02">2세대 가구</label>
										            <a href="javascript:void(0)" class="ar" data-subj="2세대 가구" title="${paramInfo.tooltipList.A0105}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_household03" name="household_type" value="03" />
										            <label for="rd_household03">3세대 가구</label>
										            <a href="javascript:void(0)" class="ar" data-subj="3세대 가구" title="${paramInfo.tooltipList.A0106}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="4세대  이상 가구" title="${paramInfo.tooltipList.A0122}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        ...
										        <%-- <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="5세대 이상 가구" title="${paramInfo.tooltipList.A0123}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li> --%>
										        ...
										        <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="1인가구" title="${paramInfo.tooltipList.A0107}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_household07" name="household_type" value="B0" />
										            <label for="rd_household07">비혈연가구</label>
										            <a href="javascript:void(0)" class="ar" data-subj="비혈연가구" title="${paramInfo.tooltipList.A0124}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										    </ul>
									    </div> 
									    ...
									    <div class="joinDefault">
									    	<ul class="multiCheckBox">
										        <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="자기집" title="${paramInfo.tooltipList.A0108}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_occupy02" name="ocptn_type" value="2" />
										            <label for="rd_occupy02">전세(월세없음)</label>
										            <a href="javascript:void(0)" class="ar" data-subj="전세" title="${paramInfo.tooltipList.A0109}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_occupy03" name="ocptn_type" value="3" />
										            <label for="rd_occupy03">보증금 있는 월세</label>
										            <a href="javascript:void(0)" class="ar" data-subj="보증금 있는 월세" title="${paramInfo.tooltipList.A0110}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_occupy04" name="ocptn_type" value="4" />
										            <label for="rd_occupy04">보증금 없는 월세</label>
										            <a href="javascript:void(0)" class="ar" data-subj="보증금 없는 월세" title="${paramInfo.tooltipList.A0111}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_occupy05" name="ocptn_type" value="5" />
										            <label for="rd_occupy05">사글세</label>
										            <a href="javascript:void(0)" class="ar" data-subj="사글세" title="${paramInfo.tooltipList.A0112}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_occupy06" name="ocptn_type" value="6" />
										            <label for="rd_occupy06">무상(관사, 사택, 친척집 등)</label>
										            <a href="javascript:void(0)" class="ar" data-subj="무상" title="${paramInfo.tooltipList.A0113}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										    </ul>
									    </div> 
									</div>
									    ...
									    <div class="joinDefault">
									    	<ul class="multiCheckBox">
										        <li>
										            ...
										            <a href="javascript:void(0)" class="ar" data-subj="단독주택" title="${paramInfo.tooltipList.A0115}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_home02" name="house_type" value="02" />
										            <label for="rd_home02">아파트</label>
										            <a href="javascript:void(0)" class="ar" data-subj="아파트" title="${paramInfo.tooltipList.A0116}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_home03" name="house_type" value="03" />
										            <label for="rd_home03">연립주택</label>
										            <a href="javascript:void(0)" class="ar" data-subj="연립주택" title="${paramInfo.tooltipList.A0117}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_home04" name="house_type" value="04" />
										            <label for="rd_home04">다세대주택</label>
										            <a href="javascript:void(0)" class="ar" data-subj="다세대주택" title="${paramInfo.tooltipList.A0118}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_home05" name="house_type" value="05" />
										            <label for="rd_home05">비주거용건물(상가,공장,여관 등)내주택</label>
										            <a href="javascript:void(0)" class="ar" data-subj="비거주용건물 내 주택" title="${paramInfo.tooltipList.A0119}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										        <li>
										            <input type="checkbox" id="rd_home06" name="house_type" value="06" />
										            <label for="rd_home06">주택이외의 거처</label>
										            <a href="javascript:void(0)" class="ar" data-subj="주택이외의 거처" title="${paramInfo.tooltipList.A0120}"><img src="/img/ico/ico_tooltip01.png" /></a>
										        </li>
										    </ul>
									    </div>
...
<!-- 									    </div> -->
							            	...
							            	<div class="joinDefault">
								            	<ul class="multiCheckBox" style="width:250px;"> 
											        ...
											        <li>
											            ...
											            <a href="javascript:void(0)" class="ar" data-subj="비거주용건물" title="${paramInfo.tooltipList.A0119}"><img src="/img/ico/ico_tooltip01.png" /></a>
											        </li>
							...
							<div class="totalResult tr03">
	                            <ol class="cateMenu type02" id="3fTabDiv">
	                                <li class="on"><a href="javascript:$interactiveLeftMenu.ui.tripleFTab('farm');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0202}">농가</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.tripleFTab('forest');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0203}">임가</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.tripleFTab('fish');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0204}">어가</a></li>
	                            </ol>
							...
							<div class="totalResult tr04">
								<ol class="cateMenu" id="companyTabDiv">
	                                <li class="on"><a href="javascript:$interactiveLeftMenu.ui.companyTab('industry');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0302}">산업분류</a></li>
	                                <li><a href="javascript:$interactiveLeftMenu.ui.companyTab('theme');" data-subj="조건설정 팁" title="${paramInfo.tooltipList.A0303}">테마업종</a></li>
	                            </ol>
							...
							<div class="totalResult tr06">
								<div class="stepBox">
									<p>나의 데이터에 저장된 목록</p>
									<ul id="mydata-color-list" class="data-list"></ul>
									<div id="mydata-color-page" class="pasing"></div>
								</div>
							</div>
						...
						<div class="btnBottom">
		                	<a href="javascript:$interactiveLeftMenu.ui.addSearchBtn();" class="btnStyle02" id="buttonMakeBtn" data-subj="조건결합설정 팁" title="현재 선택된 통계항목 창에 해당하는 통계조건을 통계버튼으로 생성하여 통계값을 조회 할 수 있어요">통계보기</a>
		                </div> 
					</div><!-- 사업체총조사 통계조건 end --> 
					...
					<div class="quickBox step03" id="companyClassListDiv">
						...
						<div class="btnBottom">
	                        <a href="javascript:$interactiveLeftMenu.ui.addSearchBtn();" class="btnStyle02">통계보기</a>
	                    </div>
					</div>
					<!-- 해당분류 세부업종 선택하기 end -->
					...
					<div class="quickBox step03" id="kosisDetailDiv">
						...
						<div class="btnBottom">
	                        <a href="javascript:interactiveMapKosis.setKosisParams();" class="btnStyle02">통계보기</a>
	                    </div>
					</div>
					<!-- 해당분류 세부업종 선택하기 end -->
