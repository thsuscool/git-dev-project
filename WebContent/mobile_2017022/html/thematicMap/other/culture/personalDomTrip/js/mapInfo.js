		...
		mapInfo : function (map) {
			...
			this.createPoiInfo = function () {
				...
				poiInfo.update = function (props) {
					var html="";
					html += '<div class="poibox" style="display: block;left:10px;bottom:-10px;width:100px;">';
					html += "<div class='poibox_in'>";
					html += '<img src="/mobile/img/marker/marker/10_10.png">';
					html += '<p><br>문화 시설</p>';
					html += '</div>';
					 html += '</div>';
			...
			this.createLegend = function() {
				...
				infoLegend.update = function (props) {
					this._div.innerHTML = "	<div class='legend_remark_section' style='bottom: 110px;'>" +
