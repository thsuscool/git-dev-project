...
//														"</tr>" +
			...
			this.updateBarChart = function (res) {
				...
				for(var i = 0; i < tempList.length; i++) {
					xAxisCat.push(tempList[i].year + '년');
					retDataList.push(tempList[i].fire1000_body_cnt);
				}
...
//				retDataList.push(res.info[0].one_person_family_cnt_2010);
				...
				var titleStr = "<h3><b>화재사고 사망자  증감현황 (명)</b></h3> </br>";
				...
				html += "출처 : 국민안전처, 1997~2011년 시도별 화재발생 현황</br>";
				html += "</div>";
				html += "</br>";
//				$(this.barChartObj).append(html);
			...
			this.resetMapInfo = function() {
				...
				$("#legendColor1_"+this.id).css("background-color", "#ff2400");
