...
//						year = "2012년";
					...
					html += '<tr>';
					html += '<th style="text-align: left; word-break:break-all;width:40%;padding:5px;font-size:12px;"><strong>' + data.properties.adm_nm + '</strong></th>';
					html += '<td style="text-align:center;">';
					html += '</td>';
					html += '</tr>';
					html += '<tr>';
//					html += '<th style="word-break:break-all;width:40%;font-size:12px;">&nbsp;&nbsp;&nbsp;'+year+'&nbsp;환경배출량</th>';
					html += '<th style="text-align: left; word-break:break-all;width:40%;font-size:11px;">&nbsp;&nbsp;환경배출량</th>';
