			...
			this.createLegend = function() {
				...
				infoLegend.update = function (props) {
					this._div.innerHTML = "	<div class='legend_remark_section'>" +
														"<a class='btn_remark'><img class='rollover' src='/mobile/img/im/btn_remarks_off.png' alt='' /></a>" +
														"<div class='remarkbox'>" +
															"<div class='remarkbox_in'>" +
																"<p class='remarks_tit'>" +
																"범례" +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(단위 : %)"+
																	"<a><img class='rollover' src='/mobile/img/im/icon_wheel_off.gif' alt='' /></a>" +
																"</p>" +
																...
																"<a class='btn_remark_offset'><img class='rollover' src='/mobile/img/im/icon_arrow_remark_off.gif' alt='' /></a>" +
															"</div>" +
														"</div>" +
													"</div>";
				};
...
//														"</tr>" +
												...
												"</div>" +
											"</div>" +
											"<span class='arrow_remark'><img src='/mobile/img/im/icon_arrow.png' alt='' /></span>" +
			...
			this.updateBarChart = function (res) {
				...
				retDataList.push(res.info[0].one_psn_family_cnt_2000);
				retDataList.push(res.info[0].one_psn_family_cnt_2005);
				retDataList.push(res.info[0].one_psn_family_cnt_2010);
				
				var titleStr = "<h3><b>1인 가구 증감 현황</b></h3> </br>";
				...
				html += "출처 : 통계청, 인구주택총조사(2000, 2005, 2010)</br>";
				html += "</div>";
				html += "</br>";
