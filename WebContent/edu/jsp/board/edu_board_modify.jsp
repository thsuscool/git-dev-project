...
function getEduBoardModView(){
	 var dataObj = new Object();
	 dataObj.gubun = "getEduBoardModView";
	 ...
	 jQuery.ajax({
	 		...
	 		success:function(data){
	 			...
	 			if( data.result.getEduBoardView.board_cd == "B"){
	 				$("#tel_no_tr").show();
	 				
	 				$("#tel_no").val(data.result.getEduBoardView.tel_no);
	 			}
...
function replaceAll(find, replace, str){
 ...
 function getEduBoardUpdate(){
	 ...
	 dataObj.gubun = "getEduBoardUpdate";
	 dataObj.board_no = "<%= board_no%>";
	 dataObj.board_rep_no = "<%= board_rep_no%>";
		...
		<div class="noticWrap">
			<div class="notic">
				...
				<tbody>
					...
					<tr style="display:none;" id="tel_no_tr">
						<th>연락처</th>
						<td>
							<input type="text" class=" mr10 w798" id="tel_no" />
						</td>
					</tr>
					<tr>
						<th>글내용</th>
					...
					<tr style="height:40px;">
						...
						<form id="formData1" name="formData1" method="post"
							...
							<input id="real_file_name"  type="file"
								name="real_file_name" style="cursor: pointer; width:100px; height:0px;" >
							</form>
						</span>
