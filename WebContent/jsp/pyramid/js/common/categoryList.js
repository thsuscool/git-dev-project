...
//		$("#container").css("min-width","970px");
		...
		var url = statsPotalDomain + "/html/board/qnaAndRequest.html?type=thema&categoryCd=THEMRQ";
...
//			console.log('cateObj', cateObj);
			...
			cateListHtml += exp;
			cateListHtml += '</p>';
//			cateListHtml += '<a href="/html/thematicMap/thematicMapList.html?theme=' + $.trim(cateObj.category) + '"class="more">';
//			cateListHtml += '<img src="/img/tm/btn_more.png" alt="더보기" />';
//			cateListHtml += '</a>';
			cateListHtml += ' ';
...
//					if (themeListObj[i].article_div == 'STATE') {
//						themeListObjHml += '<div class="status">현황</div>';
//					}
//					else {
//						themeListObjHml += '<div class="status analy">분석</div>';
//					}
					
					themeListObjHml += '<div class="details"><p class="subject" align="center" style="float:left">';
					themeListObjHml += '<a href="/html/thematicMap/thematicMapMain.html?stat_thema_map_id=' + themeListObj[i].stat_thema_map_id + '&theme=' + themeListObj[i].category + '&mapType=' + themeListObj[i].thema_map_type + '">';
