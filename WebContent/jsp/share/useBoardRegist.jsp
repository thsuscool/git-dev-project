...
if(member_id== null || member_id.equals("")){
	//response.sendRedirect("http://sgis.kostat.go.kr/html/member/login_new.html?returnPage=http://sgis.kostat.go.kr/jsp/share/useBoardRegist.jsp");	
	response.sendRedirect("/view/member/login_new?returnPage=/jsp/share/useBoardRegist.jsp");
}
%>
<!doctype html>
<html lang="ko">
...
function pageCountPlus(){
	jQuery.ajax({
		...
		data:{"hpage":"/jsp/share/useBoardRegist.jsp"},
	...
	$(document).ready(function() {
		...
		$("#boardInsertBtn").on('click', (function(e) {
			...
			if (sgis_ref_data1 == "첨부파일 찾아보기") {
				sgis_ref_data1 = "^^";
			}
			if (sgis_ref_data2 == "첨부파일 찾아보기") {
				sgis_ref_data2 = "^^";
			}
			if (sgis_ref_data3 == "첨부파일 찾아보기") {
				sgis_ref_data3 = "^^";
			}
			if (sgis_ref_data4 == "첨부파일 찾아보기") {
				sgis_ref_data4 = "^^";
			}
			
			if (sgisRefImage == "첨부파일 찾아보기") {
				sgisRefImage = "^^";
			}
			//활용사례 상세조회
			 jQuery.ajax({
...
*/
	...
	function saveGallery(){
		...
		object.userName = $("#sgisUserName").val(); // 활용자명
		object.section = $("#sgisUseGb").val();	// 구분
		object.usePurpose = $("#sgisUsePurpose").val(); // 활용목적
		object.applicationField = $("#sgisUseAreaCd").val(); // 활용분야
		object.dataUse1 = $("#sgisUseData").val(); //이용자료(통계청)
		object.dataUse2 = $("#sgisUseDataOther").val(); //이용자료(타기관)
		object.content = $("#sgisActCont").val();//주요활동내용
		object.siteUrl =$("#sgisSiteUrl").val();
		...
		jQuery.ajax({
			...
			data : {
				title : $("#sgisUseBoardTitle").val(),
				content : $("#sgisActCont").val(),
				tag : "", 
				srv_type : "6", 
...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			<p class="smr">자료신청 시 갤러리에 자동으로 임시저장 됩니다.</p>
			<div class="tabs">
								...
								<fieldset>
									<div class="f-el">
										<span class="el-h"> <label for="sgisUseBoardTitle">제목</label>
											...
											id="sgisUseBoardTitle" class="ti10" style="width: 723px;" />
										</span>
									</div>
									<div class="f-el">
									...
									<div class="f-el">
										...
										<div class="el-b">
											<textarea id="sgisActCont" class="ti10"
