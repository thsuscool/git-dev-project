...
function xmlGo(){
	 	var url = "<%=sc_webUrl%>/SGisService/coordconversion";
		var req = null
    ...
    <h2 id="q_contents">컨텐츠 영역</h2>
      ...
      <div id="article">
		...
		<!-- API 추가 시작 -->
			...
			<div class="api_wrap">
			<p class="api_title">좌표변환 서비스</p>
			<h5 class="mrt20">1.좌표변환 요청 XML문서 작성</h5>
			...
			<textarea id="xmlcontent" rows="" cols="" >&lt;?xml version='1.0' encoding='UTF-8'?&gt
&lt;SgisCoordConversionRequest xmlns='http://service.gis.knso.org/sgistype' 
  xmlns:xls='http://www.opengis.net/xls' xmlns:gml='http://www.opengis.net/gml'&gt;
&lt;svcKey&gt;API발급키&lt;/svcKey&gt;
&lt;CoordConversionRequest&gt;
&lt;CoordConvserionInfo fromSrs='LL_W' toSrs='TM_W'/&gt;
