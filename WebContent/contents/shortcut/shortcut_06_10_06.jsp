...
/*
    ********************************************************************
    * @source      : shortcut_06_10_06.jsp
    * @description : 공유마당 - OpenAPI - OpenAPI1.0-원시명부항목검색서비스
    ********************************************************************
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">
	...
	//<![CDATA[
function apiRun(){
	var winpop =window.open("shortcut_06_10_06_pop.jsp","winpop","width=700px,height=580px");
}
			...
			<div class="use_wrap">	
					...
					<div class="apiTab">
						...
						<div>
							...
							<span class="apiTab_font01"><a href="/contents/shortcut/shortcut_06_10_06.jsp">원시명부항목검색서비스 </a></span>
							<span class="apiTab_font02"><a href="/contents/shortcut/shortcut_06_10_07.jsp">집계구 기반 공간통계서비스 </a></span>
						</div>							
					</div>
					<div class="apiP01">
						<p class="apiP01Tilte">소지역 통계 항목 검색 서비스(원시명부)</p>
						<p class="apiPFont01">
						통계지리정보서비스에서 소지역 단위로 제공되어지는 통계항목중 원시명부로 구성된 통계항목을 검색을 제공하는 서비스입니다.
						</p>
					</div>
					<div class="apiP01">
						...
						<div class="apiPFont01">
							<table class="useTable" summary="자료 신청">
								...
								<tr>
									...
									<td>http://sgis1.kostat.go.kr/SGisService/getmetacode</td>
								</tr> 
								<tr>
					...
					<div class="apiP02">
							...
							<p class="apiPFont01">공간통계 요청 문서는 인증키, 통계분류항목 조회 조건으로 구성됩니다.</p>							
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg02">&lt;SgisMetaCodeRequest&gt;
	&lt;svcKey&gt;api발급키&lt;/svcKey&gt;
	&lt;MetaCodeRequest&gt;
		&lt;codeCategoryName&gt;COMP&lt;/codeCategoryName&gt;
	&lt;/MetaCodeRequest&gt;
&lt;/SgisMetaCodeRequest&gt;
							</textarea>	
							...
							<caption>요청문서 구성</caption>
								...
								<tr>
									<td>2</td>
									<td class="listTableAlian">&lt;MetaCodeReuquest&gt;</td>
									<td class="listTableAlian">&lt;codeCategoryName&gt; 또는 &lt;codename&gt;으로 검색조건을 지정할 수 있다.</td>									
								</tr>									
						</table>
					</div>
					<div class="apiP02">
							<h5 class="apiPFont02">2.2  통계 항목 설정</h5>
							<p class="apiPFont01">원시명부에서 통계 항목 설정을 위해서는 원시명부 통계 항목을 검색 후 선택하고자 하는 통계항목별 코드를 알아야 함으로 다음과 같이 두 번의 XML를 요청해야 합니다.</p>
							<h6 class="apiPFont03">2.2.1 원시명부 통계 항목 검색</h6>
							<p class="apiPFont01">원시명부는 크게 사업체, 인구, 가구로 나눠 져 있으며 각각의 카테고리 검색하는 방법은 다음과 같습니다. 사업체는 COMP, 인구는 INGU, 가구는 GAGU 라는 검색어을 가지고 있으면 이 모든 카테고리를 검색하자고 할 때는 ALL이라는 검색어를 지정 해줄 수 있습니다.</p>
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg02">&lt;MetaCodeRequest &gt;
		&lt;codeCategoryName&gt;COMP&lt;/codeCategoryName&gt;
&lt;/MetaCodeRequest &gt;</textarea>
							<h6 class="apiPFont03">2.2.2 원시명부 통계항목별 코드 검색</h6>	
							<p class="apiPFont01">원시명부 통계 항목 검색을 하게 되면 codeList가 반환됩니다. codeList안에는 codeYear ,codeID, codeName , category등으로 구성되어져 있으며 항목별 코드 검색을 하기 위해서 codeList중 검색하고자 하는 codeName의 값을 다음과 같이 설정 해주면 됩니다.</p>
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg02">&lt;MetaCodeRequest &gt;
		&lt;codeName&gt;성별&lt;/codeName&gt;
&lt;/MetaCodeRequest &gt;
							</textarea>	
							<h5 class="apiPFont02">2.3 요청문서샘플</h5>
							<p class="apiPFont01">원시명부 통계 항목 검색를 먼저 한 후 반환된 XML 문서를 확인 후 원시명부 통계항목별 코드를 검색해야 합니다..</p>
							<h6 class="apiPFont03">2.3.1 원시명부 통계 항목 검색 샘플</h6>							
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg">&lt;?xml version="1.0" encoding="euc-kr"?&gt;
&lt;SgisMetaCodeRequest xmlns="http://service.gis.knso.org/sgistype" xmlns:xls="http://www.opengis.net/xls" xmlns:gml="http://www.opengis.net/gml"&gt;
	&lt;svcKey&gt;api발급키&lt;/svcKey&gt;
	&lt;MetaCodeRequest&gt;
		&lt;codeCategoryName&gt;INGU&lt;/ codeCategoryName &gt;
     &lt;/ MetaCodeRequest &gt;
&lt;/ SgisMetaCodeRequest &gt;</textarea>
							<h6 class="apiPFont03">2.3.2 원시명부 통계항목별 코드 검색 샘플</h6>							
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg">&lt;?xml version="1.0" encoding="euc-kr"?&gt;
&lt; SgisMetaCodeRequest xmlns="http://service.gis.knso.org/sgistype" xmlns:xls="http://www.opengis.net/xls" xmlns:gml="http://www.opengis.net/gml"&gt;
	&lt;svcKey&gt;api발급키&lt;/svcKey&gt;
	&lt;MetaCodeRequest&gt;
...
&lt;/ SgisMetaCodeRequest &gt;</textarea>
					...
					<div class="apiP02">
							...
							<p class="apiPFont01">요청문서에 지정된 응답형식에 따라 인코딩 된 XML 문서가 반환됩니다.</p>
							<h5 class="apiPFont02">3.1 원시명부통계 항목 응답문서</h5>
							<p class="apiPFont01">원시명부통계 항목 응답문서은 codeYear, codeID, codName, category로 구성된 리스트로 반환됩니다.</p>
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg">&lt;?xml version="1.0" encoding="euc-kr"?&gt;
&lt;SgisMetaCodeResponse xmlns="http://service.gis.knso.org/sgistype"&gt;
&lt;MetaCodeResponse&gt;
	&lt;codeList&gt;
		&lt;codeYear&gt;2005&lt;/ codeYear &gt;
&lt;codeID&gt;sex&lt;/ codeID &gt;
&lt;codeName&gt;성별&lt;/ codeName &gt;
&lt;category&gt;INGU&lt;/ category &gt;
	&lt;/ codeList &gt;
&lt;/MetaCodeResponse&gt;
&lt;/ SgisMetaCodeResponse &gt;
							</textarea>	
							<h5 class="apiPFont02">3.2 원시명부 통계항목별 응답문서</h5>
							<p class="apiPFont01">원시명부통계별 코드 검색 응답문서는 codeValue, codeValueName로 구성된 리스트로 반환됩니다.</p>
							<textarea rows="2" cols="20" readonly="readonly" class="abiPBg">&lt;?xml version="1.0" encoding="euc-kr"?&gt;
&lt;SgisMetaCodeResponse xmlns="http://service.gis.knso.org/sgistype"&gt;
&lt;MetaCodeResponse&gt;
	&lt;codeValueList&gt;
		&lt;codeValue&gt;1&lt;/ codeValue &gt;
&lt;codeValueName&gt;남자&lt;/ codeValueName &gt;
	&lt;/ codeValueList &gt;
&lt;codeValueList&gt;
		&lt;codeValue&gt;2&lt;/ codeValue &gt;
&lt;codeValueName&gt;여자&lt;/ codeValueName &gt;
	&lt;/ codeValueList &gt;
&lt;/MetaCodeResponse&gt;
&lt;/ SgisMetaCodeResponse &gt;
							</textarea>								
...
reqXml  += "  xmlns='http://service.gis.knso.org/sgistype'"; 
		 ...
		 reqXml  += " &lt; MetaCodeRequest &gt;";
		 reqXml  += " &lt;codeCategoryName&gt;INGU&lt;/codeCategoryName&gt;";	
                     reqXml  += " &lt;/ MetaCodeRequest &gt;";
		 reqXml += " &lt;/ SgisMetaCodeRequest &gt;";
         //요청문서 작성 끝
  ...
  &lt;script type="text/javascript"&gt;
	function aaaaopen(){
		...
		var xml = "&lt;?xml version='1.0' encoding='euc-kr'?&gt;";
		    ...
		    xml += "  &lt;MetaCodeRequest&gt;";
		    xml += " &lt;codeCategoryName&gt;INGU&lt;/codeCategoryName&gt;";	
                        xml += " &lt;/MetaCodeRequest&gt;";
		    xml += " &lt;/SgisMetaCodeRequest&gt;";	
                   //요청문서 작성 끝	
