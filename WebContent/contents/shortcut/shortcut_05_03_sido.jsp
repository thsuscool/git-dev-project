...
%>
	...
	<select name="sgis_census_sido_id" id="sgis_census_sido1" class="w70 select" title="시도"  onchange="sigungu('sgis_census_id1','sgis_census_data_id1', this.value,'inUse1','years1'); " >
