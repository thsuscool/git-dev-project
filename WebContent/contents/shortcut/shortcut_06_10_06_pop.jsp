...
function xmlGo(){
	 	var url = "<%=sc_webUrl%>/SGisService/getmetacode";
		var req = null
    ...
    <h2 id="q_contents">컨텐츠 영역</h2>
      ...
      <div id="article">
		...
		<!-- API 추가 시작 -->
			...
			<div class="api_wrap">
			<p class="api_title">소지역 통계 항목 검색 서비스(원시명부)</p>
			<h5 class="mrt20">1.소지역 통계 항목 검색 서비스(원시명부) 요청 XML문서 작성</h5>
...
&lt;SgisMetaCodeRequest xmlns='http://service.gis.knso.org/sgistype'
