...
function xmlGo(){
	    var url = "<%=sc_webUrl%>/SGisService/getportraymap";
		var req = null
    ...
    <h2 id="q_contents">컨텐츠 영역</h2>
      ...
      <div id="article">
		...
		<!-- API 추가 시작 -->
			...
			<div class="api_wrap">
			<p class="api_title">WebMap 서비스 </p>
			<h5 class="mrt20">1.WebMap 서비스  XML문서 작성</h5>
...
&lt;SgisPortrayMapRequest xmlns='http://service.gis.knso.org/sgistype'
...
&lt;/xls:Output&gt;
&lt;/xls:PortrayMapRequest&gt;
&lt;/SgisPortrayMapRequest&gt;	</textarea>
