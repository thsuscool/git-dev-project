    ...
    <h2 id="q_contents">컨텐츠 영역</h2>
      ...
      <div id="article">
		...
		<!-- API 추가 시작 -->
			...
			<h5 class="mrt20">1.이벤트 리스너 등록</h5>
			<p class="api_tt2"> 1.addClick 클릭 하시면 해당 이벤트가 지정된 대상에 등록됩니다.</p>
			<p class="api_tt2"> 2.지도에 마우스 클릭 하시며면 이벤트가 발생합니다.</p>
			<p class="api_tt2"> 3.removeClick 클릭하시면  지정된 대상에서 이벤트가 삭제됩니다.</p>
