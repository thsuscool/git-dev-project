...
//(String)session.getAttribute("sc_userid") ==> sc_userid는 작동 않하므로 사용금지요망 member_id로 사용
if( session.getAttribute("sec_mem_id") != null &&  session.getAttribute("sec_mem_id").equals((String)session.getAttribute("member_id")) && (NowTime-preInsTime) < 300    ) {
	...
	try {
		...
		sgis_userkey  = request.getParameter("param_userkey");
		
		// 2017.11.06 [개발팀] 추가
		sgis_census_detail_data_id = request.getParameterValues("sgis_census_detail_data_id_new");


		//formName = (String)formNames.nextElement();														//file tag명
		fileName = request.getParameter("old_census_file");	
		//20150910 보안코딩
		//apply2.jsp는 파일이 들어가지 않으므로 아래 코드를 넣으면 않됨.
		/*
		...
		String privacy02 = StringUtil.privacy(privacy01);               // 점검
			...
			if (privacy02.equals("")) { // 개인정보 노출 점검
				if(aT.equals("INS")) {
					...
					System.out.println("[shortcut_05_03_apply2.jsp] ============ 111 ============");
					...
					for(int i = 0; i < sgis_census_id.length; i++){
						...
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_id.length [" + sgis_census_id.length);
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_req_id [" + sgis_census_req_id);
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_data_id.length [" + sgis_census_data_id.length);
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_id[i] [" + sgis_census_id[i]);
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_data_id[i] [" + sgis_census_data_id[i]);
						System.out.println("[shortcut_05_03_apply2.jsp] sc_userkey [" + sc_userkey);
						...
						/* 센서스 년도 신청 등록 */
						/******************************/
						System.out.println("[shortcut_05_03_apply2.jsp] 센서스 년도, 시도, 시군구 신청 등록");
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_id[i] [" + sgis_census_id[i]);
						System.out.println("[shortcut_05_03_apply2.jsp] sgis_census_req_id [" + sgis_census_req_id);
						System.out.println("[shortcut_05_03_apply2.jsp] years.length : [" + years.length);
						System.out.println("[shortcut_05_03_apply2.jsp] years[i] : [" + years[i]);
						System.out.println("[shortcut_05_03_apply2.jsp] sido[i] [" + sido[i]);
						System.out.println("[shortcut_05_03_apply2.jsp] sigungu[i] [" + sigungu[i]);
					...
					*/
					...
					System.out.println("[shortcut_05_05_apply2.jsp] (String)session.getAttribute(\"member_id\") [" + (String)session.getAttribute("member_id"));
				...
				/***************************************/
					...
					if((status.equals("A") || status.equals("B")) && !aT.equals("")) {
						...
						for(int i = 0; i < sgis_census_id.length; i++){
							...
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sgis_census_id.length [" + sgis_census_id.length);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sgis_census_req_id [" + sgis_census_req_id);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sgis_census_data_id.length [" + sgis_census_data_id.length);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sgis_census_id[i] [" + sgis_census_id[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sgis_census_data_id[" + i + "] [" + sgis_census_data_id[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정1 sc_userkey [" + sc_userkey);
							...
							/* 센서스 년도 신청 등록 */
							/******************************/
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 센서스 년도, 시도, 시군구 신청 등록");
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 sgis_census_id[" + i + "] [" + sgis_census_id[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 sgis_census_req_id [" + sgis_census_req_id);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 sgis_census_data_id[" + i + "] [" + sgis_census_data_id[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 years[" + i + "] : [" + years[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 sido[" + i + "] [" + sido[i]);
							System.out.println("[shortcut_05_03_apply2.jsp] 수정2 sigungu[" + i + "] [" + sigungu[i]);
			...
			System.out.print("[shortcut_05_03_apply2.jsp] sgisWebError : ");
