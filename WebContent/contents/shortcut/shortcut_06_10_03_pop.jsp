...
function xmlGo(){
	 	var url = "<%=sc_webUrl%>/SGisService/geocoder";
		var req = null
    ...
    <h2 id="q_contents">컨텐츠 영역</h2>
      ...
      <div id="article">
		...
		<!-- API 추가 시작 -->
			...
			<div class="api_wrap">
			<p class="api_title">Geocode 서비스</p>
			<h5 class="mrt20">1.Geocode 서비스  요청 XML문서 작성</h5>
...
&lt;SgisGeocodeRequest xmlns='http://service.gis.knso.org/sgistype' 
