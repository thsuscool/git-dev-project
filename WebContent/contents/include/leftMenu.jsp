						...
						<tr>
							<td align="center" colspan="2" height="25">
								...
								<table border="0" cellpadding="3" cellspacing="0" width="85%" id="table5" bgcolor="#E6EDF3">
									...
									<tr>
										<td align="left">&nbsp;- <a href="http://<%=request.getServerName()%>/OpenAPI2/contents/index.vw"> S-OpenAPI 2.0 Beta</a></td>
									</tr>
									<tr>
										<td align="left">&nbsp;- <a href="http://<%=request.getServerName()%>/contents/shortcut/shortcut_06_10_08.jsp"> S-OpenAPI 1.0 </a></td>
									</tr>
									<!-- <tr>
										<td align="left">&nbsp;- S-OpenAPI 1.0</td>
									</tr> -->
									<!-- <tr>
										<td align="left">
											<object>
