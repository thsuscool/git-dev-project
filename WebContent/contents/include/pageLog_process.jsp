  ...
  try {
    ...
    if(popYn.equals("Y")) {
         if (dcodeid.equals("110100")||dcodeid.equals("999001")){           
                  ...
                  out.println("<script>var devPop"+num+" = window.open('" +   menuUrl      +"','devPop"+num+"', 'width=1125,height=880,left=0,top=0, scrollbars=no, resizable=yes');");
                  out.println("devPop"+num+".focus();</script>");
           ...
           out.println("<script>var devPop"+num+" = window.open('" +   menuUrl      +"','devPop"+num+"', 'left=0,top=0, scrollbars=yes, resizable=yes');" );
           out.println("devPop"+num+".focus();</script>");
