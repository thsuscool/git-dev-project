...
<link href="/contents/gsks/style/style.css" rel="stylesheet" type="text/css" />
    ...
    <div class="middle_right">
    	<div class="content_title">
          <img src="/contents/gsks/images/admin_content_title_4.gif" alt="공공서비스모델 관리">
          <ul class="navigation">
            <li><img src="/contents/images/hoem_icon.gif" alt="HOME"></li>
            <li><a href="/">home</a> > <a href="/contents/gsks/">관리자</a> > <a href="/contents/gsks/gsks_04.jsp" class="ov">공공서비스모델 관리</a></li>
            </ul>                  
        </div>                
        <div class="content">        
		  <h1>첫번째</h1>
