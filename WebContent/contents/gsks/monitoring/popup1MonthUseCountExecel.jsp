...
<%
	...
	response.setHeader("Content-Disposition","attachment;filename=monthCount.xls");
...
<%
    ...
    //	api_process_date = clsNf.format(Integer.parseInt(api_process_date));
    	...
    	String dateView = api_process_date.substring(0,4)+ "년" + api_process_date.substring(4,6) + "월" + api_process_date.substring(6,8) + "일";
%>
	<tr>
		<td><%= dateView %></td>
		<td><%= use_count %></td>
