...
/*
    ********************************************************************
    * @source      : gsks_01_06_tabpage03_reply.jsp
    * @description : 관리자 - Q & A 게시판 답글
    ********************************************************************
...
<%
  ...
  MultipartRequest multi = null;
    ...
    try{
        ...
        sb.append("and sgis_board_rep_seq = ?											  \n");
...
<form name="fm" method="post" enctype="multipart/form-data">
  ...
  <div class="clear"></div>
    ...
    <div class="content">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1" style="table-layout:fixed; word-break:break-all;" summary="사이트관리에 대한 내용입니다.">
      <caption>사이트관리</caption>
      <tr>
        <th width="100" class="td_top"><center>제목</center></th>
        <td class="td_top t_end">
                <input name="sgis_board_title" id="title" type="text" maxlength="25" class="input_long" value="[답변]<%=sgis_board_title %>" />
        </th>
        </tr>
      <tr>
        <th><center>시스템</center></th>
        <td class="t_end">
          <select class="inout_short" name="sgis_board_name">
            <option value="<%=sgis_board_name %>" selected="selected"><%=sgis_board_name %></option>
          </select>
        </td>
      </tr>
        <tr>
      ...
      <tr>
        ...
        <td class="t_end"><textarea name="sgis_board_desc" cols="80" rows="20" onkeyup="len_chk('4000');">
...
<%=sgis_board_desc %>
      ...
      <div class="site_control_write_button">
          <a href="javascript:repProcess()"><img src="/contents/gsks/images/button_ok.gif" alt="확인" border="0" /></a>
