...
%>
		<select class="w200" name="sgis_census_data_id" id="sgis_census_data_id1"  onchange="yearView2('sgis_census_id1','sgis_census_data_id1','sgis_census_year1','inUse1','years1');  ">
