...
function Kairos_Count(){
	...
	var url = "/contents/gsks/proxy_sgis_unified_count2.jsp?syear="+syear+"&smonth="+smonth;
...
function date_count(P_CODE){
     ...
     window.open("${pageContext.request.contextPath}/contents/gsks/count_view_popup2.jsp?syear="+syear+"&smonth="+smonth+"&P_CODE="+P_CODE+"&",'eng','width=160, height=500, scrollbars=1, resizable=1');
...
function m_sgis_count(){
	var ym = '?year='+syear+'&month='+smonth+'&mode=<%=request.getParameter("mode")%>';
