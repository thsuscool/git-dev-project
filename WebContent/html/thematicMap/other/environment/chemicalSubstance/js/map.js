...
(function (W, D) {
	...
	sMap = {
		...
		map : function () {
			...
			this.createInfoControl = function (year, type) {
				var infoControl;
...
//					var year = "";
					if (that.thisObj.mapId == 'leftMap') {
//						year = "1999년";
						showdata = data.info[0].chemicals_discharge_init;
					}
					else {
//						year = "2013년";
						showdata = data.info[0].chemicals_discharge_cur;
					}
					var html = '<table style="text-align:left;width:auto;white-space: nowrap;word-break:break-all;padding:5px;" >';
					html += '<tr>';
					html += '<th style="text-align: left; word-break:break-all;width:40%;padding:5px;font-size:14px;"><strong>' + data.properties.adm_nm + '</strong></th>';
					html += '<td style="text-align:center;">';
					html += '</td>';
					html += '</tr>';
					html += '<tr>';
//					html += '<th style="word-break:break-all;width:40%;font-size:12px;">&nbsp;&nbsp;&nbsp;'+year+'&nbsp;환경배출량</th>';
					html += '<th style="text-align: left; word-break:break-all;width:40%;font-size:12px;">&nbsp;&nbsp;&nbsp;환경배출량</th>';
					html += '<td style="text-align:center; padding-left:15px;">&nbsp;';
					
					html += appendCommaToNumber(showdata) + '&nbsp;' + '(kg/년)';
