...
//			this.mapNavi2.create("mapNavi_2", 1, $thematicMap.rightMap, this.sMap);
...
//				this.sMap.createInfoControl("전세", $thematicMap.rightMap.mapId);
...
//			});
	...
	$thematicMap.rightMap.request = {
		...
		AreaAndStatsApis : function (_adm_cd, year) {
			console.log('right..AreaAndStatsApis.Start');
			...
			$thematicMap.rightMap.setMapzoomLevel(zoom, adm_cd, function () {
				console.log('right..CALLBACK.Start');
				$thematicMap.rightMap.BoundaryApi.getThemaOccupTypeUnder10yearDataList($thematicMap.rightMap, adm_cd);
			});
