...
//									that.setPolygonDataGeojson(that.lastGeojsonInfo.geojson);
								...
								that.thisObj.request.AreaAndStatsApis(null, that.bnd_year, target);
...
//									that.setPolygonDataGeojson(that.lastGeojsonInfo.geojson);
								...
								that.thisObj.request.AreaAndStatsApis(curSidoCd, that.bnd_year, target);
...
//									that.setPolygonDataGeojson(that.lastGeojsonInfo.geojson);
								...
								// Api 요청
								that.thisObj.request.AreaAndStatsApis(curSidoCd + curSiggCd, that.bnd_year, target);
								// that.openApiBoundaryHadmarea(curSidoCd +
								// curSiggCd, "2012", "1");
							}
							break;
...
//									that.setPolygonDataGeojson(that.lastGeojsonInfo.geojson);
						...
						case 4:
							if (that.lastGeojsonInfo != null && that.lastGeojsonInfo.adm_cd == curSidoCd + curSiggCd + curDongCd && that.lastGeojsonInfo.year == that.bnd_year) {
								...
								that.thisObj.request.AreaAndStatsApis(curSidoCd + curSiggCd + curDongCd, that.bnd_year, target);
