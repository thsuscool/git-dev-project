		...
		mapInfo : function (map) {
			...
			this.createPoiInfo = function () {
				...
				poiInfo.update = function (props) {
					this._div.innerHTML = "<div>" + "<h3 style='background-color: #000; text-align: center; margin: 0; padding: 5px 0; color: #fff; font-weight: bold;'>POI</h3>";
					this._div.innerHTML += "<div style='width: 100px; height:50px; padding: 20px 0px 0px 20px; background-color: #fff; font-size:15px'>" + '<img src="/js/plugins/jquery-easyui-1.4/images/marker-icon.png">' + '<b>보건 업종</b>' + "</div>";
