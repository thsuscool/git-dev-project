...
//														"</tr>" +
														...
														"<tr>" +
															...
															"<td>" +
																"<input type='radio' name='selectEvenLegend_"+that.id+"' id='legend_auto' value='auto' /> 자동범례 &nbsp;&nbsp;" +
																"<input type='radio' name='selectEvenLegend_"+that.id+"' id='legend_equal' value='equal' checked='checked'/> 균등범례" +
															"</td>" +
														"</tr>" +
													"</tbody>" +
												"</table>" +
			...
			// 막대차트 업데이트
			this.updateBarChart = function (res, origin) {
				console.log(res);
...
//				retDataList.push(res.info[0].one_person_family_cnt_2010);
				...
				var titleStr = "<h3><b>연도별 PC방 현황(개)</b></h3> </br>";
			...
			this.setLegendRange = function (_valPerSlice) {
				if (_valPerSlice != undefined) {
					...
					if (point.length < 5) {
						...
						var point1 = (point[0] != "" && point[0] != undefined) ? appendCommaToNumber(point[0]) : "-";
						var point2 = (point[1] != "" && point[1] != undefined) ? appendCommaToNumber(point[1]) : "-";
						var point3 = (point[2] != "" && point[2] != undefined) ? appendCommaToNumber(point[2]) : "-";
						var point4 = (point[3] != "" && point[3] != undefined) ? appendCommaToNumber(point[3]) : "-";
